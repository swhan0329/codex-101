...
// Last official scrape: 2026-06-08
...
window.codexUseCases = [
    {
        ...
        "official": {
            ...
            "promptKo": "이 프로젝트의 목표, 자주 쓰는 명령, 주의할 파일, 완료 기준을 읽고 Codex용 작업 메모를 만들어줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 피드백들을 중복 제거하고, 제품 개선 액션으로 묶어 우선순위와 근거를 표로 만들어줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 CSV 원본은 건드리지 말고 clean 버전을 만들어줘. 어떤 규칙으로 정리했는지 로그도 남겨줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use"
            ]
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 export에서 지난달 대비 매출이 가장 크게 줄어든 고객군을 찾아줘. 계산 방식과 근거 행도 보여줘.",
            "guideSectionsEn": [
                "Analyze the data",
                "Follow-up analysis"
            ]
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "최근 24시간 메일 중 내가 답장해야 할 것만 찾아서 우선순위, 이유, 답장 초안을 표로 정리해줘. 실제 전송은 하지 마.",
            "guideSectionsEn": [
                "Review your inbox",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 스크린샷을 기준으로 페이지를 구현하고, 데스크톱과 모바일에서 겹침이나 깨짐이 없는지 확인해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 코드베이스에서 로그인 요청이 들어와 DB 업데이트까지 가는 흐름을 파일별로 추적해줘. 추측은 따로 표시해줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "SwiftUI로 sidebar, detail pane, inspector가 있는 Mac 앱 shell을 만들고 빌드/실행 확인까지 해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "Chrome에서 이 관리 페이지를 열고 신청자 정보를 확인한 뒤, 입력 가능한 필드까지 채워줘. 제출 버튼은 누르기 전에 멈춰.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
                "Practical tips",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "오늘 들어온 버그 리포트를 읽고 중복, 심각도, 재현 단계 유무, 담당 후보를 정리해줘.",
            "guideSectionsEn": [
                "How to use",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 문서와 데이터를 10장짜리 발표자료로 바꿔줘. 각 슬라이드 제목, 핵심 메시지, 필요한 시각 자료를 넣어줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "skills": [],
            "promptEn": "@Codex analyze the issue mentioned in this thread and implement a fix in .",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 화면에서 카드 간격과 버튼 상태만 다듬어줘. 다른 레이아웃이나 색상 체계는 바꾸지 마.",
            "guideSectionsEn": [
                "Introduction",
                "Pick your model",
                "Development flow",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "신규 입사자 역할과 팀 정보를 바탕으로 첫 주 온보딩 체크리스트와 환영 문서 초안을 만들어줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 자료를 초보자도 이해할 수 있는 학습 리포트로 정리해줘. 핵심 용어, 예시, 내가 더 확인할 질문을 포함해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 프로젝트의 OpenAI API 호출부를 찾아 최신 권장 방식으로 옮기는 계획을 세우고, 작은 PR 단위로 수정해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 웹페이지를 구현하고 preview로 배포해줘. 로그인 없이 열리는지까지 확인하고 URL을 알려줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 앱의 회원가입부터 설정 저장까지 직접 클릭해서 QA해줘. 오류, 겹침, 콘솔 에러, 재현 단계를 기록해줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
                "Practical tips",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 데이터셋의 핵심 인사이트 5개를 찾고, 차트와 함께 의사결정용 보고서로 정리해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 메시지 스레드에서 내가 해야 할 일을 뽑고, 필요한 자료를 찾아 초안까지 만들어줘. 상대에게 보내는 건 내가 확인한 뒤 할게.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
                "Practical tips",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 아이디어를 가장 작은 POC로 줄이고, 첫 화면과 핵심 상호작용이 되는 버전을 만들어줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 게임 아이디어를 playable browser game으로 만들어줘. 조작, 점수, 실패/재시작 상태까지 확인해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 문제를 해결 후보 3개로 나누고, 각 후보를 같은 기준으로 평가한 뒤 가장 나은 방향을 구현해줘.",
            "guideSectionsEn": [
                "Introduction",
                "Start with evals",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "방금 한 작업 절차를 재사용 가능한 Codex skill로 정리해줘. 트리거 조건, 단계, 검증 명령을 포함해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "공식 문서와 현재 코드 기준으로 README의 낡은 부분을 찾아 수정하고, 변경 근거를 링크와 함께 남겨줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
                "What to give Codex",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 iOS 앱 아이디어를 SwiftUI로 스캐폴딩하고, simulator에서 첫 화면이 뜨는지 확인해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 protein-folding 가설을 검증 가능한 실험 루프로 만들어줘. baseline, 수정할 architecture, benchmark, metric, 실패 시 다음 후보를 분리해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "동작 변경 없이 이 모듈의 중복과 dead code를 정리해줘. 변경 전후 테스트로 같은 동작인지 확인해줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
                "Leverage ExecPlans",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 앱의 주요 액션 하나를 App Intent로 만들고, Shortcuts에서 보이는지 확인할 수 있게 구현해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 macOS 앱 기능을 SwiftUI로 구현하고, 앱이 실행되는지 로그와 함께 확인해줘.",
            "guideSectionsEn": [
                "Scaffold the app and build loop",
                "Leverage skills",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 SwiftUI 화면을 Liquid Glass 스타일로 이전하되 동작은 바꾸지 말고, 빌드와 simulator 확인까지 해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 Mac 앱 기능에 Logger telemetry를 추가하고, 앱을 실행해 액션 로그가 찍히는지 확인해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 버그를 iOS Simulator에서 재현하고, 스크린샷/로그/가능한 원인과 수정안을 정리해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 scRNA-seq 결과를 QC, annotation, UMAP 관점으로 검토해줘. 필터링 기준, 의심 cluster, 다시 확인할 marker를 표로 남겨줘.",
            "guideSectionsEn": [
                "Leverage skills",
                "Step-by-step guide",
                "Results"
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 후보 target들을 genetics, cohort, clinical, literature evidence로 나눠 ranking해줘. 각 점수의 근거와 약한 근거를 분리해줘.",
            "guideSectionsEn": [
                "Leverage skills",
                "Step-by-step guide"
            ]
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 bulk RNA-seq 입력을 분석 전에 검증해줘. sample sheet, FASTQ naming, reference, replicate, batch 위험을 점검하고 blocked issue를 알려줘.",
            "guideSectionsEn": [
                "Leverage skills",
                "Step-by-step guide",
                "Results"
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 승인된 vulnerability backlog를 읽고, 각 finding을 최소 수정 단위와 회귀 테스트로 나눠줘. 먼저 위험도와 blast radius를 근거와 함께 정리해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 authorized repo를 deep security scan 관점으로 검토해줘. threat model, data flow, 위험 sink/source, 재현 가능한 evidence를 우선해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 PR diff를 보안 리뷰 관점으로 봐줘. secrets, authz/authn, injection, permission, dependency 위험을 파일/라인 근거로 먼저 말해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 마이그레이션을 되돌릴 수 있는 단계로 쪼개고, 첫 단계만 구현한 뒤 테스트 결과를 보고해줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
                "Leverage ExecPlans",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 SwiftUI view를 동작 변경 없이 작은 subview로 나누고, 빌드와 UI 동작 확인까지 해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 이슈와 회의 노트를 바탕으로 PRD 초안을 만들어줘. 목표, 사용자 문제, 범위, 제외 범위, 성공 지표를 포함해줘.",
            "guideSectionsEn": [
                "Introduction",
                "Choose the sources",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 수입/지출 계획으로 12개월 현금흐름 예측 시트를 만들고, 최저 잔액 시점과 민감도를 계산해줘.",
            "guideSectionsEn": [
                "Introduction",
                "Make the forecast",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 재무 입력값으로 DCF 모델을 만들고, 할인율과 성장률 민감도 표를 포함해줘.",
            "guideSectionsEn": [
                "Introduction",
                "Create the workbook",
                "Check the valuation",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "예산과 실제 집행 데이터를 비교해 큰 차이가 난 항목, 원인 후보, 다음 액션을 workbook으로 정리해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 AI 기능의 기대 동작을 뽑아 Promptfoo eval suite로 만들고, 로컬에서 실행되는지 확인해줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 피드백과 이슈를 사용자 스토리로 정리하고, 논의 가능한 UI 목업 방향 2개를 만들어줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 서비스의 가장 좁은 ChatGPT 앱 use case를 정하고, 필요한 tools와 MCP server 골격을 만들어줘.",
            "guideSectionsEn": [
                "What you build",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 모바일 앱 아이디어를 Expo Router 기반으로 스캐폴딩하고, Expo Go에서 확인할 수 있게 만들어줘.",
            "guideSectionsEn": [
                "Start with Expo Go",
                "Use the Expo plugin",
                "Iteration process",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 API 조회 작업을 JSON 출력이 안정적인 CLI로 만들어줘. 실패 코드는 명확히 하고 README 예시도 추가해줘.",
            "guideSectionsEn": [
                "Introduction",
                "How to use",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "최근 24시간 Slack에서 내가 답하거나 처리해야 할 것만 찾아서 중요도순으로 정리해줘. 이미 해결된 건 제외해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 운영 절차를 dry run, 실행, 로그 확인, 결과 보고 순서로 진행해줘. 실패하면 멈추고 원인을 정리해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "@Sites 이 프로젝트를 팀 내부 리뷰용 사이트로 저장해줘. 먼저 build를 검증하고, 바로 배포하지 말고 saved version과 접근 권한 옵션을 설명해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 회의 요약을 바탕으로 고객에게 보낼 후속 메일, 내부 공유 메시지, CRM 업데이트 항목을 나눠서 작성해줘.",
            "guideSectionsEn": [
                "Introduction",
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 advisory를 기준으로 우리 repo가 영향을 받는지 확인하고, 안전한 audit 계획과 수정 후보를 정리해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "오늘 오후 회의의 참석자, 이전 논의, 내가 준비해야 할 질문, 결정해야 할 항목을 한 페이지 브리프로 정리해줘.",
            "guideSectionsEn": [
    ...
    },
    {
        ...
        "official": {
            ...
            "promptKo": "이 행사 정보를 바탕으로 준비 일정, 역할 분담, 홍보 문안, 당일 체크리스트, 후속 메일을 만들어줘.",
            "guideSectionsEn": [
                "Introduction",
