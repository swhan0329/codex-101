...
const translations = {
    ko: {
        ...
        overview_lead: "이 페이지는 먼저 두 가지를 보여줍니다. 지금 어떤 모델과 사용 방식을 고르면 되는지, 그리고 처음 사용자와 실무 사용자가 어디서부터 읽으면 좋은지입니다. 오늘 반영한 변경 내용은 하단 Changelog에서만 확인할 수 있습니다.",
        ...
        overview_update_2_desc: "개인 플랜 한도뿐 아니라 `GPT-5.5` 사용량 표, `Free $0`·`Go $8`·`Plus $20`·`Pro from $100`, Business·Enterprise의 Codex-only pay-as-you-go seat, 그리고 현재 `codex/pricing` 문서의 Plus / Pro 5x / Pro 20x / Business / API Key 구성을 다시 맞췄습니다. 오늘은 Help Center Codex rate card도 함께 확인해, 2026년 4월 23일 이후 대부분의 Plus, Pro, Business, Enterprise/Edu/Gov/Health 고객이 토큰 기반 rate card를 쓰도록 마이그레이션됐다는 최신 보조 근거를 추가했습니다.",
    ...
    en: {
        ...
        overview_lead: "This section starts with two things: which model/surface choices are current, and where first-time and professional users should begin. Today's edits now live only in the bottom Changelog.",
