...
const translations = {
    ko: {
        ...
        overview_update_1_desc: "`codex/models`를 2026년 6월 16일 기준으로 가장 먼저 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex-spark`의 Pro research preview 역할이 유지되는지 대조했습니다. 현재 models 문서는 계속 `gpt-5.2`와 `gpt-5.3-codex`를 ChatGPT 로그인 기준 Codex에서는 deprecated라고 명시합니다. 2026년 6월 12일 ChatGPT 릴리스 노트는 별도로 GPT-5.2 Instant/Thinking/Pro가 ChatGPT에서 retired됐다고 설명하므로, Codex product deprecation, ChatGPT 일반 모델 retirement, API availability를 분리해서 읽어야 합니다.",
        ...
        changelog_item_1: "`codex/models`를 먼저 재확인했고, `gpt-5.5` 우선 추천과 `gpt-5.2`/`gpt-5.3-codex`의 ChatGPT 인증 Codex deprecated 상태, 그리고 6월 12일 ChatGPT GPT-5.2 retirement 범위를 분리했습니다.",
        changelog_item_2: "Codex rate card의 token-based credit 표와 GPT-5.5 125/12.50/750 credits per 1M tokens 범위를 요금제 설명에 반영했습니다.",
        changelog_item_3: "Quickstart의 standalone installer, App/IDE/CLI/Cloud 선택 구조, 원격 연결 주의점을 다시 맞췄습니다.",
        changelog_item_4: "공식 use-case catalog 60개를 다시 감사했고, promptEn/promptKo 누락 0, HTML entity normalization 후 official prompt mismatch 0, multiline 한국어 요약 회귀 0을 확인했습니다.",
        ...
        changelog_item_6: "로그인된 Chrome으로 X, Threads, LinkedIn을 다시 확인했지만 X blank body, Threads search shell, LinkedIn navigation shell만 읽혀 새 social-only claim은 추가하지 않았습니다.",
    ...
    en: {
        ...
        changelog_item_1: "Rechecked `codex/models` first, kept `gpt-5.5` as the top recommendation, and separated ChatGPT-authenticated Codex deprecation from the June 12 ChatGPT GPT-5.2 retirement.",
        changelog_item_2: "Added the Codex rate-card token-credit scope, including GPT-5.5 at 125/12.50/750 credits per 1M tokens.",
        ...
        changelog_item_4: "Audited all 60 official use cases again and confirmed 0 missing promptEn, 0 missing promptKo, 0 official prompt mismatches after HTML-entity normalization, and 0 multiline Korean summary regressions.",
        ...
        changelog_item_6: "Rechecked X, Threads, and LinkedIn through logged-in Chrome; X returned a blank body, Threads exposed only search shell text, and LinkedIn exposed only navigation shell text, so no new social-only claim was added.",
        ...
        field_tips_intro: "On June 16, 2026, I rechecked X, Threads, and LinkedIn through the logged-in Chrome session. Social posts are treated as field signals, while product status and enablement steps are checked against official Codex docs and OpenAI announcements. This pass did not add a new social-only claim because the readable surfaces were blank or shell-only.",
