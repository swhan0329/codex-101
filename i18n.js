...
const translations = {
    ko: {
        ...
        s18_field_credit: "이번 실행의 Chrome 소셜 확인에서는 로그인된 X와 LinkedIn에서 사람별 최신 글을 다시 읽었습니다. 소셜 글은 현장 신호로만 다루고, AGENTS/config 기반 재현성, permissions 확인, OpenAI Developers plugin 활용처럼 공식 문서와 맞는 팁만 유지합니다.",
        ...
        field_tips_intro: "2026-06-13 로그인된 Chrome 세션으로 X와 LinkedIn의 사람별 최신 글을 다시 확인했습니다. 소셜 글은 “현장 신호”로만 쓰고, 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        s18_field_credit: "This run used logged-in Chrome to recheck recent posts from individual people on X and LinkedIn. Social posts stay as field signals, and the guide keeps only tips that fit official docs, such as AGENTS/config reproducibility, permission checks, and OpenAI Developers documentation workflows.",
        ...
        field_tips_intro: "On June 13, 2026, I rechecked recent posts from individual people on X and LinkedIn through the logged-in Chrome session. Social posts are treated as field signals, while product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
