...
const translations = {
    ko: {
        ...
        changelog_item_6: "Chrome 플러그인으로 X, Threads, LinkedIn을 확인했습니다. X는 targeted query 페이지의 본문이 비어 있었고, LinkedIn의 Windows feature flag community claim은 공식 문서와 분리해 운영 메모로만 유지했습니다.",
    ...
    en: {
        ...
        changelog_item_6: "The Chrome plugin checked X, Threads, and LinkedIn. X opened with a blank readable body for the targeted query; LinkedIn repeated a Windows feature-flag community claim, which stays separate as an operating note.",
