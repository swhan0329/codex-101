...
const translations = {
    ko: {
        ...
        overview_update_4_desc: "2026년 6월 11일 Codex app 26.609 릴리스는 Plus/Pro rate-limit reset banking, Developer mode의 Browser/CDP 접근, App composer의 `/init`, Enterprise Computer Use 확대, Windows Computer Use per-app access control을 추가했습니다. 2026년 6월 18일 Enterprise spend-controls 발표는 Global Admin Console의 ChatGPT+Codex credit usage analytics, user/product/model별 breakdown, unified Cost API, workspace/group/user별 spend limit를 설명하므로, 일반 사용자 기능이 아니라 Enterprise admin 운영 메모로 분리했습니다. 2026년 6월 21일 Samsung Electronics 배포 발표는 한국 전 직원과 전 세계 DX 직원에게 ChatGPT Enterprise와 Codex를 제공하는 enterprise adoption 사례로 분리했습니다.",
        overview_update_5_title: "관련 발표 전체 재점검",
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 21일 Samsung Electronics 배포 발표는 ChatGPT Enterprise와 Codex를 한국 전 직원 및 전 세계 DX 직원에게 제공하는 대규모 rollout이고, Codex가 비개발 직무에서도 internal tools, websites, automated workflows를 만드는 방향으로 확장된다는 사례입니다. 2026년 6월 18일 `New usage analytics and updated spend controls for enterprises`는 Codex credit usage를 포함하지만 Enterprise admin visibility/control 발표입니다. 둘 다 Codex의 새 모델 순서, 일반 사용자 플랜, preview/GA, feature flag, activation 절차, credential/permission 변화가 아닙니다.",
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, Samsung Electronics 배포는 Korea-scale enterprise adoption 맥락으로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 X, Threads, LinkedIn을 다시 확인했지만 공식 문서로 대조 가능한 OpenAI/Codex 팀 새 social tip은 추가하지 않았습니다.",
    ...
    en: {
        ...
        overview_update_4_desc: "The June 11 Codex app 26.609 release adds Plus/Pro rate-limit reset banking, Developer mode for Browser/CDP access, `/init` in the app composer, expanded Enterprise Computer Use, and per-app access controls for Computer Use on Windows. The June 18 Enterprise spend-controls announcement adds Global Admin Console credit usage analytics for ChatGPT and Codex, user/product/model breakdowns, unified Cost API access, and workspace/group/user spend limits, so the guide treats it as Enterprise admin operations rather than a new consumer Codex feature. The June 21 Samsung Electronics deployment is tracked as enterprise adoption and Korea-scale rollout context.",
        overview_update_5_title: "Broader launch-post sweep",
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 21 Samsung Electronics announcement makes ChatGPT Enterprise and Codex available to all Samsung Electronics employees in Korea and all global DX employees, and frames Codex as useful for both technical and non-technical work such as internal tools, websites, and automated workflows. The June 18 Enterprise analytics/spend-controls announcement includes Codex credit usage, but it is an Enterprise admin visibility and spend-governance update. I did not describe either item as a Codex model-order, consumer-plan, preview/GA, feature-flag, activation, credential, or permission change.",
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; the Samsung Electronics deployment is Korea-scale enterprise adoption context, not a consumer feature change.",
        changelog_item_6: "Used the saved social research note as the baseline and rechecked X, Threads, and LinkedIn; no new officially corroborated OpenAI/Codex team tip was added.",
