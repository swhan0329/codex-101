...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 2일 `Codex for every role, tool, and workflow` 발표는 role-specific plugins, Sites preview, 더 넓어진 annotations를 공식 발표 문구로 유지하고, 같은 날 `Codex is becoming a productivity tool for everyone` 글은 지식근로자가 data analysis, research, knowledge artifact, lightweight tool 생성에 Codex를 쓰는 배경 보고서로 분리했습니다. 2026년 6월 9일 Nextdoor, Notion, Wasmer customer story는 workflow 예시로만 유지했습니다. 2026년 6월 10일 Oracle cloud commitment 발표는 eligible Oracle Universal Credits로 OpenAI 모델과 Codex 접근을 여는 조달/파트너십 메모로, 2026년 6월 11일 black-hole simulation 글은 검증 가능한 과학 코드/알고리즘 탐색 사례로만 반영했습니다. 새 모델 순서, 일반 사용자 플랜, preview/GA, feature flag, activation 절차처럼 단정하지 않았습니다. 2026년 5월 13일 TanStack/Mini Shai-Hulud 대응 공지는 macOS 사용자가 2026년 6월 12일까지 Codex App/CLI 등 OpenAI macOS 앱을 공식 경로로 업데이트해야 하는 보안 운영 메모로 유지했습니다.",
        ...
        changelog_item_2: "`codex/pricing`, Quickstart, config/profile, remote connections, Sites, Bedrock, MCP, hooks, plugins, skills를 다시 확인했고 모델/원격/Sites 흐름의 큰 변경은 없었습니다.",
        changelog_item_3: "Quickstart의 데스크톱 App 우선 설치 흐름과 App/IDE/CLI/Cloud 선택 구조를 다시 맞췄습니다.",
        ...
        changelog_item_6: "Chrome으로 X, Threads, LinkedIn을 다시 확인했고, 새 social-only claim은 추가하지 않았습니다. Oracle cloud commitment와 black-hole simulation 글은 공식 발표 기반 맥락으로만 반영했습니다.",
        ...
        field_tips_intro: "2026-06-11 Chrome 로그인 세션으로 X, Threads, LinkedIn을 확인했지만 새로 넣을 만한 공식 근거의 social-only claim은 없었습니다. X의 Oracle 언급처럼 공식 발표로 확인되는 내용만 별도 발표 맥락에 반영했고, 아래에는 이미 공식 문서와 대조해 둔 사용 습관만 남겼습니다.",
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 2 `Codex for every role, tool, and workflow` launch remains official announcement language for role-specific plugins, Sites preview, and broader annotations. The same-day `Codex is becoming a productivity tool for everyone` post remains report context for knowledge-worker use across data analysis, research, knowledge artifacts, workflow automation, and lightweight tools. The June 9 Nextdoor, Notion, and Wasmer customer stories remain workflow examples. The June 10 Oracle cloud commitment post is procurement/partnership context for eligible Oracle Universal Credits access to OpenAI models and Codex, and the June 11 black-hole simulation article is a research workflow example for inspectable, testable scientific code and algorithm exploration. I did not treat either as a new model order, consumer plan, preview/GA, feature flag, or activation change. The May 13 TanStack / Mini Shai-Hulud response stays as a security operations note: macOS users should update OpenAI macOS apps, including Codex App and Codex CLI, from official paths by June 12, 2026.",
        ...
        changelog_item_2: "Rechecked pricing, Quickstart, config/profile, remote connections, Sites, Bedrock, MCP, hooks, plugins, and skills; no major model, remote-control, or Sites flow reversal was needed.",
        changelog_item_3: "Aligned Quickstart wording with the desktop App-first setup flow while keeping App, IDE, CLI, and Cloud as separate choices.",
        ...
        changelog_item_6: "Rechecked X, Threads, and LinkedIn in Chrome and added no new social-only claims. The Oracle cloud commitment and black-hole simulation posts were reflected only as official-source context.",
        ...
        s7_pb_computer_t: "Computer use",
        s7_pb_computer_d: "Use it for GUI tasks that are hard to verify through CLI tools or plugins alone. On macOS, install the plugin first and grant Screen Recording plus Accessibility. On Windows, the May 29, 2026 release notes say eligible users can use Computer Use, but it is not available in the EEA, the UK, or Switzerland at launch. Keep each task scoped to one app and one flow at a time.",
        s7_pb_image_t: "Image generation",
        ...
        field_tips_intro: "On June 11, 2026, I checked recent X, Threads, and LinkedIn Codex posts through Chrome, then kept only patterns corroborated by official docs or official launch posts.",
