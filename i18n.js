...
const translations = {
    ko: {
        ...
        overview_update_1_desc: "`codex/models`를 2026년 6월 12일 기준으로 가장 먼저 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex-spark`의 Pro research preview 역할이 유지되는지 대조했습니다. 현재 models 문서는 계속 `gpt-5.2`와 `gpt-5.3-codex`를 ChatGPT 로그인 기준 Codex에서는 deprecated라고 명시합니다. API-key authentication을 쓰는 workflow는 API models page에서 별도로 확인해야 하며, 임의 provider에서 Chat Completions API를 쓰는 Codex 경로는 future release에서 제거될 예정인 deprecated 지원입니다.",
        overview_update_2_title: "요금제·크레딧 구조 재정리",
        overview_update_2_desc: "개인 플랜 한도뿐 아니라 GPT-5.5 pricing scope를 다시 나눴습니다. Plus/Pro/Business 사용량 표에는 GPT-5.5 local-message 범위가 보이지만, API Key 사용량 표는 아직 GPT-5.5를 Not available로 둡니다. `Free $0`·`Go $8`·`Plus $20`·`Pro from $100`, Plus의 web/CLI/IDE/iOS 접근, Business·Enterprise의 credits 설명, 그리고 현재 `codex/pricing` 문서의 Plus / Pro 5x / Pro 20x / Business / API Key 구성도 다시 맞췄습니다. 가격표에는 Sites가 Business/Enterprise에서 available, Plus/Pro/API Key에서는 unavailable로 표시되고, Sites FAQ는 preview 기간 동안 무료라고 설명합니다. ChatGPT for Excel 같은 agentic feature도 유효 시점 이후 Codex usage limits를 공유할 수 있으므로, usage dashboard와 `/status`를 함께 확인하라고 정리했습니다.",
        ...
        overview_fact_3_desc: "Quickstart는 모든 ChatGPT 플랜에 Codex가 포함된다고 설명하고, 데스크톱에서는 App 설치 경로를 먼저 보여주되 IDE extension, CLI, Cloud도 정식 시작 경로로 유지합니다. `codex/pricing`은 Plus / Pro 5x / Pro 20x / Business / Enterprise & Edu / API Key 표를 유지하고, Plus 설명에는 GPT-5.5, GPT-5.4, GPT-5.3-Codex가 함께 표시됩니다. 사용량 표에도 `gpt-5.3-codex` 범위가 남아 있지만 models 문서는 이 모델을 ChatGPT 로그인 기준 deprecated로 표시하므로, 가격 한도와 추천 모델 상태는 서로 다른 범위로 읽어야 합니다. Sites는 현재 Business/Enterprise preview로 표시되고, pricing FAQ는 preview 기간 동안 무료라고 설명합니다. 실무 문서는 사용량 표, token credit 표, usage dashboard, App `Settings > Profile`의 lifetime tokens/token activity, 실제 모델 선택기, API 모델 가격표를 섞지 말고 함께 확인하도록 고쳤습니다.",
        ...
        changelog_item_2: "Codex app 26.609의 reset banking, Developer mode, `/init`, Enterprise/Windows Computer Use 권한 변화를 반영했습니다.",
        ...
        changelog_item_6: "Ona 인수 발표는 closing 전 enterprise execution 방향으로만 분리했고, Chrome 소셜 확인에서는 새 social-only claim을 추가하지 않았습니다.",
        ...
        s18_field_credit: "이번 실행의 Chrome 소셜 확인에서는 X, Threads, LinkedIn 모두 읽혔습니다. 다만 대부분 community opinion이거나 공식 문서와 같은 내용이어서, AGENTS/config 기반 재현성, permissions 확인, OpenAI Developers plugin 활용처럼 공식 문서로 확인되는 팁만 유지하고 social-only claim은 추가하지 않았습니다.",
        ...
        field_tips_intro: "2026-06-12 Chrome으로 X, Threads, LinkedIn을 다시 확인했습니다. X는 검색 화면 본문을 읽을 수 없었고 Threads는 로딩 제한에 걸렸으며 LinkedIn은 검색 화면만 확인됐습니다. 그래서 social-only claim은 추가하지 않고, 아래에는 이미 공식 문서와 대조한 사용 습관만 남겼습니다.",
        field_tip_1_t: "안 쓴 작업부터 context gap 찾기",
        field_tip_1_d: "Codex를 쓰지 않고 지나간 작업을 보면 모델 능력보다 맥락, skill, 도구 연결, 습관이 빠져 있는 경우가 많습니다. 반복 설명은 memory, skill, repo-local docs로 옮겨 다음 프롬프트를 짧게 만드세요.",
        field_tip_2_t: "규칙 더미보다 맥락을 찾는 방법",
        field_tip_2_d: "AGENTS.md, skill, runbook에는 모든 절차를 박아 넣기보다 이 프로젝트에서 중요한 것, 더 읽을 위치, 검증 방식, 의도를 적습니다. 자연어 지시문은 모델이 다시 읽을 운영 자산이므로 사람이 리뷰해야 합니다.",
        field_tip_3_t: "/goal에는 검증 가능한 종료 조건",
        field_tip_3_d: "긴 작업은 바로 “해줘”로 던지기보다 완료 여부를 판정할 숫자, 상태, 테스트, 화면 기준을 같이 줍니다. 필요하면 먼저 plan/research를 만든 뒤 /goal을 그 계획과 연결하세요.",
        field_tip_4_t: "긴 작업은 화면 evidence까지 남기기",
        field_tip_4_d: "성능, 문서, 프론트엔드 작업은 측정, 수정, 재측정, 브라우저 확인, PR 본문 정리까지 하나의 루프로 맡깁니다. 테스트 로그만 남기지 말고 실제 화면 스크린샷과 확인 URL도 evidence로 남기세요.",
        field_tip_5_t: "Automations로 나중 일 챙기기",
        field_tip_5_d: "Codex에게 내일 다시 확인할 thread, 매주 반복할 리포트, CI/PR 상태, flaky test 후속 확인을 맡기세요. 사람 머릿속의 “나중에 봐야지”를 thread automation과 recurring task로 빼내는 흐름입니다.",
        field_tip_6_t: "Browser와 Chrome을 역할별로 나누기",
        field_tip_6_d: "local preview와 공개 페이지 검증은 in-app browser에 맡기고, 로그인 세션, 확장, 기존 탭, 여러 계정 상태가 필요한 일은 Chrome extension으로 분리합니다. 여러 탭과 subagent를 쓰면 검증도 병렬화할 수 있습니다.",
        field_tip_7_t: "Worktrees, Skills, Connectors, Subagents를 loop로 묶기",
        field_tip_7_d: "반복 업무는 한 번 더 prompt하는 방식보다 loop로 설계합니다. Automations는 발견과 triage, worktrees는 격리된 수정, skills는 재사용 지식, plugins/connectors는 실제 업무 도구, subagents는 병렬 검토를 맡깁니다.",
        field_tip_8_t: "좋은 자료를 skill과 SDK surface로 증류하기",
        field_tip_8_d: "좋은 글, talk, 운영 습관은 그냥 읽고 끝내지 말고 skill/reference로 남깁니다. 앱이나 내부 자동화에서 Codex를 호출해야 할 때는 Codex SDK를 별도 automation surface로 보고 공식 설치 경로를 확인합니다.",
        ...
        field_tips_refs: '원글 및 근거: <a href="https://x.com/_lopopolo/status/2062950475989725465" target="_blank">Ryan Lopopolo</a> · <a href="https://x.com/dkundel/status/2062650378089594955" target="_blank">dominik /goal</a> · <a href="https://x.com/reach_vb/status/2063713960495558940" target="_blank">VB loop</a> · <a href="https://x.com/gdb/status/2063437915347136554" target="_blank">Greg Brockman</a> · <a href="https://x.com/nicolekcha/status/2063362606543622322" target="_blank">nicole</a> · <a href="https://developers.openai.com/codex/use-cases/follow-goals" target="_blank">Official /goal</a> · <a href="https://developers.openai.com/codex/app/automations" target="_blank">Official Automations</a> · <a href="https://developers.openai.com/codex/skills" target="_blank">Official Skills</a> · <a href="https://developers.openai.com/codex/subagents" target="_blank">Official Subagents</a> · <a href="https://developers.openai.com/codex/app/browser" target="_blank">Official Browser</a> · <a href="https://developers.openai.com/codex/app/chrome-extension" target="_blank">Official Chrome</a> · <a href="https://developers.openai.com/codex/sdk" target="_blank">Official SDK</a>',
        // Footer
    ...
    en: {
        ...
        overview_update_1_desc: "The June 12 run started by re-checking `codex/models` first, confirming that `gpt-5.5` is still the top recommendation, that `gpt-5.4` remains the fallback path, and that `gpt-5.4-mini` and `gpt-5.3-codex-spark` keep their fast local/subagent and Pro research-preview roles. The models page still lists `gpt-5.2` and `gpt-5.3-codex` as deprecated in Codex when you sign in with ChatGPT. API-key workflows should verify API models separately, and the arbitrary-provider Chat Completions path remains a deprecated Codex support path that will be removed in a future release.",
        overview_update_2_title: "Pricing and credits refreshed",
        overview_update_2_desc: "The guide keeps GPT-5.5 pricing scope split cleanly: Plus/Pro/Business usage-limit tables now show GPT-5.5 local-message ranges, while the API Key usage table still lists GPT-5.5 as not available. It also keeps `Free $0`, `Go $8`, `Plus $20`, `Pro from $100`, Plus web/CLI/IDE/iOS access, Business/Enterprise credits language, and the current Plus / Pro 5x / Pro 20x / Business / API Key pricing layout aligned. Pricing still lists Sites as available for Business/Enterprise and unavailable for Plus/Pro/API Key, while the Sites FAQ says it is free during preview. Agentic features such as ChatGPT for Excel can share Codex usage limits once pricing for those features is effective.",
        ...
        changelog_item_2: "Reflected Codex app 26.609 reset banking, Developer mode, `/init`, and Enterprise/Windows Computer Use permission changes.",
        ...
        changelog_item_6: "Separated the Ona acquisition as pre-closing enterprise execution direction and added no new social-only claims from the Chrome check.",
        ...
        s18_field_credit: "Chrome social verification was readable on X, Threads, and LinkedIn this run. Most visible tips were community opinion or already covered by official docs, so only officially corroborated points such as AGENTS/config reproducibility, permission checks, and the OpenAI Developers plugin stayed in the guide.",
        ...
        field_tips_intro: "On June 12, 2026, I rechecked X, Threads, and LinkedIn through Chrome. X did not expose readable search text, Threads hit a loading timeout, and LinkedIn only exposed the search shell, so I added no social-only claims and kept only habits already corroborated by official docs.",
        field_tip_1_t: "Look for context gaps in the work you skipped",
        field_tip_1_d: "When you did not use Codex for a task, the blocker is often missing context, skills, tool connections, or habit rather than model capability. Move repeated background into memory, skills, and repo-local docs so future prompts get shorter.",
        field_tip_2_t: "Teach Codex how to seek context",
        field_tip_2_d: "Do not pack every procedure into AGENTS.md, skills, or runbooks. Write what matters in the project, where to read more, how to verify, and what the intent is. Humans should review this natural language because Codex will rely on it later.",
        field_tip_3_t: "Give /goal verifiable exit criteria",
        field_tip_3_d: "For long-running work, avoid a vague “do this” handoff. Give Codex a number, state, test, or rendered screen that proves completion. When needed, have it draft the plan or research first, then attach /goal to that plan.",
        field_tip_4_t: "Leave screen evidence for long work",
        field_tip_4_d: "Performance, docs, and frontend work should become one loop: measure, change, measure again, check the browser, and write the PR body. Leave actual screenshots and URLs, not only test logs.",
        field_tip_5_t: "Use Automations for future work",
        field_tip_5_d: "Ask Codex to revisit unresolved threads tomorrow, rebuild a weekly report, monitor CI or PR state, and check flaky tests later. Move “I should remember to check that” into thread automations and recurring tasks.",
        field_tip_6_t: "Split Browser and Chrome by job",
        field_tip_6_d: "Use the in-app browser for local previews and public-page checks. Use the Chrome extension when login state, extensions, existing tabs, or multiple accounts matter. Multiple tabs and subagents can make verification parallel.",
        field_tip_7_t: "Bind Worktrees, Skills, Connectors, and Subagents into loops",
        field_tip_7_d: "Repeated work is better designed as a loop than prompted again by hand. Automations handle discovery and triage, worktrees isolate edits, skills carry reusable knowledge, plugins/connectors reach real tools, and subagents review in parallel.",
        field_tip_8_t: "Distill good material into skills and SDK surfaces",
        field_tip_8_d: "Do not just read strong posts, talks, and operating habits. Turn them into skills or references. When Codex needs to run inside an app or internal automation, treat the Codex SDK as a separate automation surface and verify the official install path.",
        ...
        field_tips_refs: 'Originals and sources: <a href="https://x.com/_lopopolo/status/2062950475989725465" target="_blank">Ryan Lopopolo</a> · <a href="https://x.com/dkundel/status/2062650378089594955" target="_blank">dominik /goal</a> · <a href="https://x.com/reach_vb/status/2063713960495558940" target="_blank">VB loop</a> · <a href="https://x.com/gdb/status/2063437915347136554" target="_blank">Greg Brockman</a> · <a href="https://x.com/nicolekcha/status/2063362606543622322" target="_blank">nicole</a> · <a href="https://developers.openai.com/codex/use-cases/follow-goals" target="_blank">Official /goal</a> · <a href="https://developers.openai.com/codex/app/automations" target="_blank">Official Automations</a> · <a href="https://developers.openai.com/codex/skills" target="_blank">Official Skills</a> · <a href="https://developers.openai.com/codex/subagents" target="_blank">Official Subagents</a> · <a href="https://developers.openai.com/codex/app/browser" target="_blank">Official Browser</a> · <a href="https://developers.openai.com/codex/app/chrome-extension" target="_blank">Official Chrome</a> · <a href="https://developers.openai.com/codex/sdk" target="_blank">Official SDK</a>',
