...
const translations = {
    ko: {
        ...
        changelog_item_6: "Chrome 소셜 확인은 X/Threads/LinkedIn 모두 읽혔지만 공식 문서로 확인된 팁만 유지하고 social-only claim은 추가하지 않았습니다.",
    ...
    en: {
        ...
        changelog_item_6: "Chrome social verification was readable on X, Threads, and LinkedIn; only officially corroborated tips stayed in the guide, with no social-only claim added.",
