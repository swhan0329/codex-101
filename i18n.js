...
const translations = {
    ko: {
        ...
        overview_update_1_desc: "`codex/models`를 2026년 6월 23일 기준으로 가장 먼저 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex-spark`의 Pro research preview 역할이 유지되는지 대조했습니다. 현재 models 문서는 계속 `gpt-5.2`와 `gpt-5.3-codex`를 ChatGPT 로그인 기준 Codex에서는 deprecated라고 명시합니다. 2026년 6월 12일 ChatGPT 릴리스 노트의 GPT-5.2 Instant/Thinking/Pro retirement도 별도 범위로 유지되므로, Codex product deprecation, ChatGPT 일반 모델 retirement, API availability를 분리해서 읽어야 합니다.",
        ...
        overview_update_4_desc: "2026년 6월 11일 Codex app 26.609 릴리스는 Plus/Pro rate-limit reset banking, Developer mode의 Browser/CDP 접근, App composer의 `/init`, Enterprise Computer Use 확대, Windows Computer Use per-app access control을 추가했습니다. 2026년 6월 18일 Enterprise spend-controls 발표는 Global Admin Console의 ChatGPT+Codex credit usage analytics, user/product/model별 breakdown, unified Cost API, workspace/group/user별 spend limit를 설명하므로 Enterprise admin 운영 메모로 분리했습니다. 2026년 6월 21일 Samsung Electronics 배포는 enterprise adoption 사례입니다. 2026년 6월 22일 Daybreak와 Patch the Planet은 Codex Security, GPT-5.5-Cyber trusted defender access, maintainer support, human review, disclosure/patch governance 맥락으로만 기록했습니다.",
        overview_update_5_title: "관련 발표 전체 재점검",
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 22일 Daybreak 발표는 Codex Security plugin update, GPT-5.5-Cyber full limited release, Daybreak Cyber Partner Program, Patch the Planet을 묶어 findings에서 fixes로 가는 defensive workflow를 설명합니다. 같은 날 Codex-maxxing 글은 Codex를 persistent workspace처럼 쓰며 큰 목표를 검증 가능한 단계로 나누고 workstream continuity와 human oversight를 유지하는 운영 패턴입니다. 이 항목들은 보안/장기작업 운영 맥락이며, Codex의 새 모델 순서, 일반 사용자 플랜, preview/GA, feature flag, activation 절차, credential/permission 변화가 아닙니다.",
        ...
        changelog_item_1: "`codex/models`를 먼저 재확인했고, `gpt-5.5` 우선 추천과 `gpt-5.2`/`gpt-5.3-codex`의 ChatGPT 인증 Codex deprecated 상태가 유지되는지 확인했습니다.",
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, Daybreak/Patch the Planet/Codex-maxxing은 보안 및 long-running work 운영 맥락으로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 X, Threads, LinkedIn을 다시 확인했고, LinkedIn의 OpenAI Daybreak 게시물은 공식 발표로만 반영했습니다.",
        overview_update_7_title: "X 실무 팁 반영",
        ...
        m2_f: "ChatGPT 로그인으로 쓰는 Codex에서는 deprecated로 표시된 예전 Codex 모델입니다. 기존 script, config, `codex exec --model` 명령에 남아 있다면 최신 추천 모델로 바꾸는 편이 안전합니다.", m2_u: "기존 설정 정리/마이그레이션",
        m3_f: "텍스트 전용 리서치 프리뷰 모델. 거의 즉각적인 실시간 코딩 반복에 최적화되었으며 ChatGPT Pro 사용자에게 제공됩니다.", m3_u: "실시간 코딩, 빠른 반복",
        s3_rec_note: "💡 최신 `codex/models` 기준 공식 가이드는 모델 선택기에서 `gpt-5.5`가 보이면 대부분의 작업을 거기서 시작하라고 권장합니다. 오늘은 같은 모델 페이지가 API Access를 true로 표시하고 pricing의 Plus/Pro/Business 사용량 표도 GPT-5.5 local-message 범위를 보여주며, API Key 표도 GPT-5.5/GPT-5.4/GPT-5.4 mini를 usage-based로 표시합니다. API-key 사용자는 실제 Codex 모델 선택기와 표준 API pricing을 같이 확인하세요. 비용/속도 균형이 중요하면 `gpt-5.4`를 계속 사용하면 됩니다. API에서는 `gpt-5.5`와 `gpt-5.5-pro`를 사용할 수 있으며, Pro는 더 높은 정확도가 필요한 Responses API/Batch API 작업에 적합합니다. 더 빠르고 가벼운 코딩 작업이나 subagent에는 `gpt-5.4-mini`, 거의 즉각적인 반복에는 ChatGPT Pro research preview인 `gpt-5.3-codex-spark`를 검토하세요. `gpt-5.2`와 `gpt-5.3-codex`는 ChatGPT 로그인 Codex 기준 deprecated이고, ChatGPT 릴리스 노트는 GPT-5.2 Instant/Thinking/Pro가 2026년 6월 12일부터 ChatGPT에서 retired됐다고 별도로 설명합니다.",
        ...
        field_tips_intro: "2026-06-22 로그인된 Chrome 세션으로 X, Threads, LinkedIn의 최신 글을 다시 확인했습니다. 소셜 글은 “현장 신호”로만 쓰고, 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        overview_update_1_desc: "The June 23 run started by re-checking `codex/models` first, confirming that `gpt-5.5` is still the top recommendation, that `gpt-5.4` remains the fallback path, and that `gpt-5.4-mini` and `gpt-5.3-codex-spark` keep their fast local/subagent and Pro research-preview roles. The models page still lists `gpt-5.2` and `gpt-5.3-codex` as deprecated in Codex when you sign in with ChatGPT. The June 12 ChatGPT release notes separately say GPT-5.2 Instant, Thinking, and Pro are retired in ChatGPT, so the guide keeps Codex product deprecation, ChatGPT model retirement, and API availability in separate lanes.",
        ...
        overview_update_4_desc: "The June 11 Codex app 26.609 release adds Plus/Pro rate-limit reset banking, Developer mode for Browser/CDP access, `/init` in the app composer, expanded Enterprise Computer Use, and per-app access controls for Computer Use on Windows. The June 18 Enterprise spend-controls announcement adds Global Admin Console credit usage analytics for ChatGPT and Codex, user/product/model breakdowns, unified Cost API access, and workspace/group/user spend limits, so the guide treats it as Enterprise admin operations. The June 21 Samsung Electronics deployment is enterprise adoption context. The June 22 Daybreak and Patch the Planet posts are security operating context for Codex Security, GPT-5.5-Cyber trusted defender access, maintainer support, human review, and disclosure/patch governance.",
        overview_update_5_title: "Broader launch-post sweep",
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 22 Daybreak announcement groups a Codex Security plugin update, GPT-5.5-Cyber full limited release, the Daybreak Cyber Partner Program, and Patch the Planet into a findings-to-fixes defensive workflow. The same-day Codex-maxxing post frames Codex as a persistent workspace for breaking large goals into verifiable steps, preserving workstream continuity, and keeping human oversight clear. I treated these as security and long-running-work operating context, not as Codex model-order, consumer-plan, preview/GA, feature-flag, activation, credential, or permission changes.",
        ...
        changelog_item_1: "Rechecked `codex/models` first and confirmed `gpt-5.5` is still the top recommendation while `gpt-5.2` and `gpt-5.3-codex` remain deprecated for ChatGPT-authenticated Codex.",
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; Daybreak, Patch the Planet, and Codex-maxxing are separated as security and long-running-work operating context.",
        changelog_item_6: "Used the saved social research note as the baseline and rechecked X, Threads, and LinkedIn; LinkedIn's OpenAI Daybreak post was reflected only through official sources.",
        overview_update_7_title: "X practitioner tips added",
        ...
        m2_f: "Deprecated for Codex when you sign in with ChatGPT. If older scripts, configs, or `codex exec --model` commands still reference it, migrate them to the current recommended models.", m2_u: "Legacy config cleanup",
        ...
        s3_rec_note: "💡 The latest `codex/models` guidance says to start with `gpt-5.5` when it appears in your picker. Today that page marks GPT-5.5 API Access as true, pricing shows GPT-5.5 local-message ranges for Plus/Pro/Business, and the API Key table lists GPT-5.5/GPT-5.4/GPT-5.4 mini as usage-based. API-key users should verify the actual Codex picker and standard API pricing. If cost/latency matters more, keep using `gpt-5.4`. In the API, `gpt-5.5` and `gpt-5.5-pro` are available, with Pro aimed at higher-accuracy Responses API and Batch API work. Use `gpt-5.4-mini` for faster lighter tasks or subagents, and `gpt-5.3-codex-spark` for near-instant ChatGPT Pro research-preview iteration. `gpt-5.2` and `gpt-5.3-codex` are deprecated for Codex when signing in with ChatGPT, while GPT-5.2 Instant/Thinking/Pro are separately retired in ChatGPT as of June 12, 2026.",
        computer_use_kicker: "Computer use",
        ...
        field_tips_intro: "On June 22, 2026, I reused the saved people/social research note as the baseline and rechecked X, Threads, and LinkedIn through the logged-in Chrome session. Social posts are treated as field signals, while product status and enablement steps are checked against official Codex docs and OpenAI announcements. This pass did not add a new social-only claim because no new officially corroborated Codex team tip surfaced.",
        ...
        field_tips_refs: 'Originals and sources: <a href="codex-team-social-research-2026-06-13.md" target="_blank">People and social research note</a> · <a href="https://x.com/dkundel/status/2062650378089594955" target="_blank">Dominik /goal</a> · <a href="https://x.com/heccbrent/status/2062651567413637441" target="_blank">Brent /goal</a> · <a href="https://x.com/reach_vb/status/2065520558620500082" target="_blank">VB Build macOS Apps</a> · <a href="https://x.com/reach_vb" target="_blank">VB Codex Mobile note</a> · <a href="https://developers.openai.com/codex/remote-connections" target="_blank">Official Remote connections</a> · <a href="https://x.com/_lopopolo/status/2064742429438198056" target="_blank">Ryan AGENTS.md</a> · <a href="https://x.com/nicolekcha/status/2063362606543622322" target="_blank">Nicole skills framing</a> · <a href="https://developers.openai.com/codex/use-cases/follow-goals" target="_blank">Official /goal</a> · <a href="https://developers.openai.com/codex/sites" target="_blank">Official Sites</a> · <a href="https://openai.com/index/openai-to-acquire-ona/" target="_blank">Official Ona announcement</a> · <a href="https://developers.openai.com/codex/skills" target="_blank">Official Skills</a> · <a href="https://developers.openai.com/codex/plugins" target="_blank">Official Plugins</a>',
