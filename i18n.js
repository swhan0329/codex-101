...
const translations = {
    ko: {
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, AWS GA는 provider/enterprise 경로로, Workspace Agents는 ChatGPT 팀-agent preview로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했지만 전용 Chrome 제어 도구가 노출되지 않아 검증되지 않은 소셜 claim은 추가하지 않았습니다.",
        ...
        field_tips_intro: "2026-06-24 저장된 social research note를 baseline으로 다시 확인했습니다. 이번 실행에서는 전용 Chrome 제어 도구가 노출되지 않아 로그인형 X, Threads, LinkedIn 최신 글을 충분히 검증하지 못했고, 검증되지 않은 소셜 claim은 추가하지 않았습니다. 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; AWS GA is separated as provider/enterprise context and Workspace Agents as a ChatGPT team-agent preview.",
        changelog_item_6: "Reused the saved social research note as the baseline, but no dedicated Chrome-control tool was exposed this run, so no unverified social-only claim was added.",
        ...
        field_tips_intro: "On June 24, 2026, I reused the saved people/social research note as the baseline. A dedicated Chrome-control tool was not exposed in this run, so logged-in X, Threads, and LinkedIn updates were not promoted as fresh evidence. Social posts remain field signals only; product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
