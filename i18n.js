...
const translations = {
    ko: {
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, 6월 29일 EU workforce transition report는 연구/인력 전환 맥락으로만 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했고, Chrome social 표면에서 새로 공식 문서로 대조 가능한 Codex 팁은 없었습니다.",
        ...
        s18_field_credit: "이번 실행의 Chrome 소셜 확인에서는 로그인된 X, Threads, LinkedIn에서 최신 글을 다시 읽었습니다. 소셜 글은 현장 신호로만 다루고, AGENTS/config 기반 재현성, permissions 확인, OpenAI Developers plugin 활용처럼 공식 문서와 맞는 팁만 유지합니다.",
        ...
        field_tips_intro: "2026-06-30 저장된 social research note를 baseline으로 다시 확인했습니다. Chrome에서 X, Threads, LinkedIn을 열 수는 있었지만 X/Threads는 현재 글 본문을 신뢰할 만큼 노출하지 않았고 LinkedIn은 기존 Codex Remote/agentic-work 맥락 중심이어서 검증되지 않은 소셜 claim은 추가하지 않았습니다. 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; the June 29 EU workforce transition report is separated as research/workforce context only.",
        changelog_item_6: "Reused the saved social research note as the baseline; Chrome social surfaces did not reveal a new Codex tip that could be promoted with official-doc corroboration.",
        ...
        s18_field_credit: "This run used logged-in Chrome to recheck recent posts on X, Threads, and LinkedIn. Social posts stay as field signals, and the guide keeps only tips that fit official docs, such as AGENTS/config reproducibility, permission checks, and OpenAI Developers documentation workflows.",
        ...
        field_tips_intro: "On June 30, 2026, I reused the saved people/social research note as the baseline. Chrome could open X, Threads, and LinkedIn, but X/Threads did not expose reliable current post bodies and LinkedIn surfaced existing Codex Remote plus agentic-work context rather than a new official-doc-corroborated Codex tip. Social posts remain field signals only; product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
