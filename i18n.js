...
const translations = {
    ko: {
        ...
        overview_update_1_desc: "`codex/models`를 2026년 7월 3일 기준으로 가장 먼저 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex-spark`의 Pro research preview 역할이 유지되는지 대조했습니다. `gpt-5.2`와 `gpt-5.3-codex`는 ChatGPT 인증 Codex 기준 deprecated로 분리했고, API code-generation 문서의 일부 legacy codex-family 언급은 Codex product model picker 안내와 섞지 않도록 별도 Platform/API 범위로 남겼습니다.",
        overview_update_2_title: "요금제·크레딧 구조 재정리",
        overview_update_2_desc: "개인 플랜 한도뿐 아니라 GPT-5.5 pricing scope를 다시 나눴습니다. Plus/Pro/Business 사용량 표에는 GPT-5.5 local-message 범위가 보이고, API Key 사용량 표도 GPT-5.5/GPT-5.4/GPT-5.4 mini를 usage-based로 표시합니다. Help Center Codex rate card는 대부분 고객에게 token-based pricing을 기본으로 안내하며, GPT-5.5는 1M tokens 기준 input 125 credits, cached input 12.50 credits, output 750 credits로 표시됩니다. legacy average-message rate는 migration 전인 일부 Enterprise 고객 범위로만 남겼습니다. 2026년 6월 11일부터 6월 24일까지 eligible Plus/Pro 초대는 첫 Codex 메시지 이후 양쪽에 30일짜리 banked rate-limit reset을 줄 수 있으므로, 초대 조건과 만료일은 dialog/current terms에서 확인해야 합니다.",
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. OpenAI news index는 오늘도 2026년 6월 30일 GeneBench-Pro와 core-dump debugging/epidemiology 글을 최신 카드로 보여주므로 research, benchmark, 또는 technical operating context로만 기록했습니다. 2026년 6월 24일 AWS 발표는 enterprise/provider 배포 맥락으로, Workspace Agents는 ChatGPT 팀 계정용 shared cloud agent research preview로 분리했습니다. 2026년 6월 26일 GPT-5.6 Sol preview는 일부 신뢰 파트너/조직 preview와 broader availability coming soon으로 분리했고, HP partnership는 enterprise adoption 사례로만 남겼습니다. Daybreak/Patch the Planet/Codex-maxxing은 계속 보안/장기작업 운영 맥락이며, 새 일반 Codex 모델 순서, 일반 사용자 플랜, local app 설정 키, credential/permission 변화로 단정하지 않았습니다.",
        ...
        changelog_item_2: "Pricing/rate card를 다시 확인했고 GPT-5.5 usage-based/API Key 및 125/12.50/750 credits per 1M tokens 범위가 유지되는지 확인했습니다.",
        changelog_item_3: "Quickstart, App/IDE/CLI/Cloud, Remote connections, Windows, Sites, config, MCP/hooks/plugins/skills 문서를 다시 훑었고, 7월 2일 반영한 config/remote-control 설명과 충돌하는 새 공식 변경은 없었습니다.",
        changelog_item_4: "공식 use-case catalog 60개를 다시 감사했고, trailing-space까지 포함해 Starter prompt 원문 60개와 local `official.promptEn`을 맞췄습니다. promptEn/promptKo 누락 0, official prompt mismatch 0, multiline 한국어 요약 회귀 0입니다.",
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, news index 최신 카드가 6월 30일 글들에 머물러 있어 연구/벤치마크/운영 사례로만 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했지만 Chrome extension surface가 현재 연결되지 않아 X/Threads/LinkedIn 최신 글을 신뢰성 있게 읽지 못했습니다. 검증되지 않은 소셜 claim은 추가하지 않았습니다.",
        ...
        field_tips_intro: "2026-07-03 저장된 social research note를 baseline으로 다시 확인했습니다. 오늘은 Chrome extension surface가 연결되지 않아 X, Threads, LinkedIn 최신 글을 안정적으로 읽지 못했습니다. 그래서 검증되지 않은 소셜 claim은 추가하지 않았고, 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로만 대조했습니다.",
    ...
    en: {
        ...
        overview_update_1_desc: "The July 3 run started by re-checking `codex/models` first, confirming that `gpt-5.5` is still the top recommendation, that `gpt-5.4` remains the fallback path, and that `gpt-5.4-mini` and `gpt-5.3-codex-spark` keep their fast local/subagent and Pro research-preview roles. `gpt-5.2` and `gpt-5.3-codex` remain deprecated for ChatGPT-authenticated Codex. Some API code-generation guidance still contains legacy codex-family language, so the guide keeps Codex product model-picker guidance and Platform/API guidance in separate lanes.",
        overview_update_2_title: "Pricing and credits refreshed",
        overview_update_2_desc: "The guide keeps GPT-5.5 pricing scope split cleanly: Plus/Pro/Business usage-limit tables show GPT-5.5 local-message ranges, and the API Key usage table lists GPT-5.5/GPT-5.4/GPT-5.4 mini as usage-based. The Help Center Codex rate card now matters more for rollout planning: most customers should use the token-based pricing rate card, GPT-5.5 is listed at 125 input / 12.50 cached input / 750 output credits per 1M tokens, and the legacy average-message rate card remains only for the remaining unmigrated Enterprise subset. From June 11 through June 24, 2026, eligible Plus and Pro invitations can grant both users a banked rate-limit reset after the recipient sends their first Codex message, so users should check the invite dialog and current terms for eligibility and expiry.",
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The OpenAI news index still shows the June 30 GeneBench-Pro and core-dump debugging/epidemiology posts as the newest cards, so the guide keeps them as research, benchmark, or technical operating context only. The June 24 AWS announcement remains enterprise/provider deployment context, and Workspace Agents remains a ChatGPT team-workspace shared cloud-agent research preview. The June 26 GPT-5.6 Sol preview is separated as limited partner/organization preview plus broader availability coming soon, while the HP partnership remains enterprise adoption context. Daybreak, Patch the Planet, and Codex-maxxing remain security and long-running-work operating context, not general Codex model-order, consumer-plan, local app config, credential, or permission changes.",
        ...
        changelog_item_2: "Rechecked pricing and the rate card; GPT-5.5 usage-based/API Key scope and the 125/12.50/750 credits per 1M tokens rate remain aligned.",
        changelog_item_3: "Rechecked Quickstart, App/IDE/CLI/Cloud, Remote connections, Windows, Sites, config, MCP, hooks, plugins, and skills; no new official change conflicted with the July 2 config or remote-control wording.",
        changelog_item_4: "Audited all 60 official use cases again and aligned local Starter prompts with the official text, including trailing spaces. The catalog has 0 missing promptEn, 0 missing promptKo, 0 official prompt mismatches, and 0 multiline Korean summary regressions.",
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; the newest news cards still sit at June 30, so those posts stay separated as research, benchmark, or operating context only.",
        changelog_item_6: "Reused the saved social research note as the baseline, but the Chrome extension surface was not available in this run. No unverified X, Threads, or LinkedIn claim was promoted.",
        ...
        field_tips_intro: "On July 3, 2026, I reused the saved people/social research note as the baseline. The Chrome extension surface was not available in this run, so I could not reliably read the latest X, Threads, or LinkedIn posts. No unverified social claim was added; product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
