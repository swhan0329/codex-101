...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 24일 AWS 발표는 Commercial/GovCloud AWS, AWS-native security/governance/procurement/billing, Codex on Amazon Bedrock을 다루므로 enterprise/provider 배포 맥락으로만 설명했습니다. Workspace Agents는 Codex-powered라고 설명되지만 ChatGPT 팀 계정용 shared cloud agent preview이고, 발표문은 Codex app support를 coming soon으로 둡니다. 2026년 6월 26일 GPT-5.6 Sol preview는 일부 신뢰 파트너/조직 preview와 broader availability coming soon으로 분리했습니다. 2026년 6월 25일 agentic-work 연구는 비개발 지식 업무 확장 배경으로, 6월 28일 HP partnership는 enterprise adoption 사례로만 분리했습니다. Daybreak/Patch the Planet/Codex-maxxing은 계속 보안/장기작업 운영 맥락이며, 새 일반 Codex 모델 순서, 일반 사용자 플랜, local app 설정 키, credential/permission 변화로 단정하지 않았습니다.",
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, GPT-5.6 Sol preview, HP partnership, agentic-work 연구를 각각 Platform/API, enterprise adoption, research context로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했지만 신뢰할 만한 Chrome social 읽기 경로가 없어 검증되지 않은 소셜 claim은 추가하지 않았습니다.",
        ...
        field_tips_intro: "2026-06-29 저장된 social research note를 baseline으로 다시 확인했습니다. 이번 실행에서는 X, Threads, LinkedIn을 신뢰할 만큼 읽을 수 있는 Chrome 제어 경로가 충분하지 않아 검증되지 않은 소셜 claim은 추가하지 않았습니다. 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; GPT-5.6 Sol, the HP partnership, and agentic-work research are separated as Platform/API, enterprise adoption, and research context.",
        changelog_item_6: "Reused the saved social research note as the baseline, but there was no reliable Chrome social reading path, so no unverified social-only claim was added.",
        ...
        field_tips_intro: "On June 29, 2026, I reused the saved people/social research note as the baseline. A reliable Chrome reading path for logged-in X, Threads, and LinkedIn was not available in this run, so social updates were not promoted as fresh evidence. Social posts remain field signals only; product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
