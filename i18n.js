...
const translations = {
    ko: {
        ...
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했습니다. Chrome plugin 연결은 성공했지만 X/Threads/LinkedIn에서 공식 문서로 대조 가능한 새 social-only claim은 확인하지 못했습니다.",
        ...
        field_tips_intro: "2026-07-08 저장된 social research note를 baseline으로 다시 확인했습니다. Chrome plugin 연결은 성공했지만 X targeted search는 readable body가 비어 있었고, Threads는 DOMContentLoaded 전에 timeout이 났으며, LinkedIn은 이미 공식 문서로 확인된 Goal Mode / Locked Computer Use 상태를 요약한 제3자 한국어 글만 보여주었습니다. 검증되지 않은 social-only claim은 추가하지 않았고, 제품 상태와 활성화 방법은 공식 Codex 문서, Developers 블로그, OpenAI 발표로만 대조했습니다.",
    ...
    en: {
        ...
        changelog_item_6: "Reused the saved social research note as the baseline. Chrome plugin connection succeeded, but X, Threads, and LinkedIn did not surface any new social-only claim that could be cross-checked against official docs.",
        ...
        field_tips_intro: "On July 8, 2026, I reused the saved people/social research note as the baseline. Chrome plugin connection succeeded, but targeted X search produced a blank readable body, Threads timed out before DOMContentLoaded, and LinkedIn surfaced only a third-party Korean post summarizing already official Goal Mode / Locked Computer Use status. No unverified social-only claim was added; product status and enablement steps are checked against official Codex docs, Developers blog posts, and OpenAI announcements.",
