...
const translations = {
    ko: {
        ...
        overview_update_1_desc: "`codex/models`를 2026년 5월 11일 기준으로 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex`의 Cloud/code review 역할, `gpt-5.3-codex-spark`의 Pro research preview 역할이 유지되는지 대조했습니다. 특히 Codex 안에서는 `gpt-5.5`가 ChatGPT 로그인 경로에서만 보이고 API 키 로그인에는 아직 나오지 않는 점을 상단부터 분명히 반영했습니다.",
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/news`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 5월 8일 `Running Codex safely at OpenAI`는 sandboxing, approvals, auto-review, managed requirements, network policy, keyring auth, forced workspace login, rules, OpenTelemetry audit trail을 묶은 운영 근거로 반영했습니다. 5월 7일 `GPT-5.5-Cyber`/Codex Security plugin 발표는 Codex 모델 선택기 변경이 아니라 보안·운영 확장으로 분리했습니다.",
        overview_update_6_title: "Docs MCP·설정 기준 재점검",
        overview_update_6_desc: "Docs MCP와 config reference를 다시 확인해 shared CLI/IDE config, AGENTS.md 유도 문구, `review_model`, `plan_mode_reasoning_effort`, granular approvals, `web_search`, permissions profile, keyring credential storage, forced login/workspace, shell environment policy, project root markers, TUI 설정, OpenTelemetry, apps/plugins/skills 제어 키를 최신 흐름에 맞췄습니다.",
        ...
        overview_fact_6_desc: "`review_model`, `plan_mode_reasoning_effort`, `approval_policy.granular`, `approvals_reviewer`, top-level `web_search`, `tools.web_search`, `tools.view_image`, `service_tier`, `personality`, `default_permissions`, `windows.sandbox`, `windows.sandbox_private_desktop`, `model_instructions_file`, `memories.disable_on_external_context`, `sqlite_home`, shell environment policy, project root markers, TUI 설정, protected paths, JSON schema, app connector 권한, feature flag, permissions profile, keyring credential storage, forced login/workspace, OpenTelemetry export, plugin 배포 계층, 로컬 OS 샌드박스와 cloud split runtime 설명을 함께 최신 기준으로 맞췄습니다. 5월 8일 `Running Codex safely at OpenAI`와 5월 7일 Codex Security plugin은 보안·운영 섹션의 근거로 유지하고, Codex의 기본 모델 선택 가이드와는 분리했습니다.",
        ...
        s5_refs: '출처: <a href="https://developers.openai.com/codex/quickstart/" target="_blank">Quickstart</a> · <a href="https://developers.openai.com/codex/windows" target="_blank">Windows guide</a> · <a href="https://developers.openai.com/codex/app/windows" target="_blank">Windows app</a> · <a href="https://developers.openai.com/codex/ide" target="_blank">IDE extension</a> · <a href="https://openai.com/index/advanced-account-security/" target="_blank">Advanced Account Security</a> · <a href="https://openai.com/index/running-codex-safely/" target="_blank">Running Codex safely</a>',
        ...
        changelog_item_5: "Docs MCP, best practices, config 문서를 다시 확인하고 `plan_mode_reasoning_effort`, shell environment policy, project root markers, TUI settings, keyring auth, telemetry를 보강했습니다.",
        ...
        s13_refs: '출처: <a href="https://developers.openai.com/codex/learn/best-practices/" target="_blank">Codex Best practices</a> · <a href="https://developers.openai.com/codex/config-reference/" target="_blank">config reference</a> · <a href="https://developers.openai.com/codex/concepts/sandboxing/" target="_blank">sandboxing</a> · <a href="https://openai.com/index/running-codex-safely/" target="_blank">Running Codex safely</a> · <a href="https://openai.com/index/openai-on-aws/" target="_blank">OpenAI on AWS</a>',
        // Section 13
        ...
        s18_field_credit: "이번 실행에서는 Chrome 연결은 성공했지만 브라우저 정책이 Google, X, Threads, LinkedIn 접근을 차단했습니다. 그래서 기존 공개 출처·공식 문서·저장소를 유지했고, 브라우저에서 새로 검증하지 못한 소셜 팁은 추가하지 않았습니다.",
    ...
    en: {
        ...
        overview_update_1_desc: "The May 11 run started by re-checking `codex/models`, confirming that `gpt-5.5` is still the top recommendation, that `gpt-5.4` remains the fallback path, and clarifying how `gpt-5.4-mini`, `gpt-5.3-codex`, and `gpt-5.3-codex-spark` split fast local/subagent, Cloud/code-review, and Pro research-preview roles. The login-path distinction stays explicit up front: inside Codex, `gpt-5.5` currently appears only with ChatGPT sign-in, not API-key authentication.",
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/news`, and `openai.com/codex` together. The May 8 `Running Codex safely at OpenAI` launch is now reflected as enterprise operating guidance around sandboxing, approvals, auto-review, managed requirements, network policy, keyring auth, forced workspace login, rules, and OpenTelemetry audit trails. The May 7 `GPT-5.5-Cyber` / Codex Security plugin launch is treated as security-operations context, not a Codex model-picker change.",
        overview_update_6_title: "Docs MCP and config rechecked",
        overview_update_6_desc: "Docs MCP and the config reference were rechecked around shared CLI/IDE setup, the AGENTS.md steering snippet, `review_model`, `plan_mode_reasoning_effort`, granular approvals, `web_search`, permissions profiles, keyring credential storage, forced login/workspace, shell environment policy, project root markers, TUI settings, telemetry, and app/plugin/skill controls.",
        ...
        overview_fact_4_desc: "The IDE docs now cover both VS Code-style editors and JetBrains across macOS, Windows, and Linux. The Windows app docs now split the flow clearly: install from Microsoft Store or `winget install Codex -s msstore`, run the native agent in PowerShell, keep the native Windows sandbox on through Default permissions, restart after switching the agent to WSL2, and choose the integrated terminal separately. The guide now frames native Windows as the default path and WSL2 as the right path when your repo or toolchain is Linux-native.",
        ...
        overview_fact_6_desc: "The guide now keeps `review_model`, `plan_mode_reasoning_effort`, granular approvals, `approvals_reviewer`, top-level `web_search`, `tools.web_search`, `tools.view_image`, `service_tier`, `personality`, `default_permissions`, Windows sandbox keys, `model_instructions_file`, `memories.disable_on_external_context`, `sqlite_home`, shell environment policy, project root markers, TUI settings, protected paths, JSON schema, app-connector controls, feature flags, permissions profiles, keyring credential storage, forced login/workspace controls, OpenTelemetry export, plugin packaging, and the split cloud runtime aligned with current docs. This run keeps May 8 `Running Codex safely at OpenAI` and the May 7 Codex Security plugin as security/operations evidence, not changes to the Codex model-picker order.",
        ...
        changelog_item_5: "Rechecked Docs MCP, best practices, and config docs, then added `plan_mode_reasoning_effort`, shell environment policy, project root markers, TUI settings, keyring auth, and telemetry notes.",
        ...
        s18_field_credit: "Chrome connected successfully in this run, but the active browser policy blocked Google, X, Threads, and LinkedIn access. I kept the existing public sources, official docs, and repositories, and did not add fresh social tips that could not be verified in-browser.",
