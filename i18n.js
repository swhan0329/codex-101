...
const translations = {
    ko: {
        ...
        changelog_item_5: "Codex/API의 Amazon Bedrock 문서와 June 1 OpenAI/AWS 발표를 추가하고, Docs MCP, config, app/settings, OpenAI API changelog/deprecations, Apps SDK changelog, API 모델 문서를 다시 확인했습니다.",
    ...
    en: {
        ...
        changelog_item_5: "Added Codex/API Amazon Bedrock docs plus the June 1 OpenAI/AWS announcement, then rechecked Docs MCP, config, app/settings, the OpenAI API changelog/deprecations, Apps SDK changelog, and API model docs.",
