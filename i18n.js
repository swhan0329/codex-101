...
const translations = {
    ko: {
        ...
        overview_lead: "이 페이지는 먼저 두 가지를 보여줍니다. 지금 어떤 모델과 사용 방식을 고르면 되는지, 그리고 처음 사용자와 실무 사용자가 어디서부터 읽으면 좋은지입니다. 오늘 반영한 변경 내용은 바로 아래 토글에서 먼저 확인할 수 있습니다.",
        ...
        overview_update_1_desc: "`codex/models`를 오늘 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex`의 Cloud/code review 역할이 유지되는지 대조했습니다. 특히 Codex 안에서는 `gpt-5.5`가 ChatGPT 로그인 경로에서만 보이고 API 키 로그인에는 아직 나오지 않는 점을 상단부터 분명히 반영했습니다.",
        overview_update_2_title: "요금제·크레딧 구조 재정리",
        overview_update_2_desc: "개인 플랜 한도뿐 아니라 `GPT-5.5` 사용량 표, `Free $0`·`Go $8`·`Plus $20`·`Pro from $100`, Business·Enterprise의 Codex-only pay-as-you-go seat, 그리고 현재 `codex/pricing` 문서의 Plus / Pro 5x / Pro 20x / Business / API Key 구성을 다시 맞췄습니다. Help Center Codex rate card도 함께 확인해, 2026년 4월 23일 이후 대부분의 Plus, Pro, Business, Enterprise/Edu/Gov/Health 고객이 토큰 기반 rate card를 쓰도록 마이그레이션됐다는 보조 근거를 유지했습니다.",
        ...
        overview_update_4_title: "App 기능 흐름 재확인",
        overview_update_4_desc: "2026년 4월 16일 `Codex for (almost) everything` 발표와 현재 `app/features`·`app/automations`를 함께 대조해 background computer use, 더 많은 plugins, multiple terminal tabs, SSH devbox, richer artifact/sidebar 흐름이 현재 문서 구조에 맞게 묶여 있는지 재확인했습니다.",
        overview_update_5_title: "관련 발표 전체 재점검",
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어보며 2026년 4월 30일 `Advanced Account Security`, 4월 28일 `OpenAI models, Codex, and Managed Agents come to AWS`, 4월 23일 `Introducing GPT-5.5`, 4월 16일 `Codex for (almost) everything`, 4월 2일 `Codex now offers pay-as-you-go pricing for teams`, 그리고 app/plugins/skills/automations 문서를 함께 대조했고 이를 상단 토글과 가격·앱·운영 보안 설명에 직접 반영했습니다.",
        ...
        overview_fact_3_desc: "Quickstart는 모든 ChatGPT 플랜에 Codex가 포함된다고 설명합니다. `codex/pricing`은 오늘도 Plus / Pro 5x / Pro 20x / Business / API Key 표와 Plus 로컬 메시지 범위(`gpt-5.5` 15-80, `gpt-5.4` 20-100, `gpt-5.4-mini` 60-350, `gpt-5.3-codex` 30-150)를 유지합니다. 다만 OpenAI Help Center의 최신 Codex rate card는 2026년 4월 23일 이후 대부분의 Plus, Pro, Business, Enterprise/Edu/Gov/Health 고객이 토큰 기반 rate card를 써야 한다고 더 넓게 설명합니다. 따라서 실무 문서는 사용량 표와 token credit 표를 함께 보여주고, 실제 과금/한도 판단은 usage dashboard와 rate card를 같이 확인하도록 고쳤습니다.",
        overview_fact_4_title: "IDE·Windows 경로 재정리",
        overview_fact_4_desc: "IDE 문서는 이제 VS Code 계열과 JetBrains 모두를 정식 경로로 다루고, macOS·Windows·Linux 사용을 함께 설명합니다. Windows 가이드는 네이티브 Windows 실행을 기본 축으로 두고 `elevated` sandbox를 우선 권장하며, `unelevated`는 관리자 승인이나 정책 때문에 elevated 설정이 막힐 때의 대안으로 설명합니다. WSL2는 Linux-native 툴체인이 필요하거나 기존 개발 워크플로가 이미 WSL2에 있을 때 고르는 경로로 분리했습니다.",
        ...
        overview_source_28: "OpenAI on AWS",
        ...
        changelog_item_2: "가격 설명을 Plus / Pro 5x / Pro 20x / Business / API Key 읽는 법에 맞게 고치고, Help Center rate card 기준으로 대부분의 플랜이 토큰 기반 표로 이동했다는 보조 근거를 추가했습니다.",
        ...
        changelog_item_6: "Codex Pet을 skill 설치와 반복 가능한 pet 제작 workflow 사례로 설명하고, 실제 제작 과정을 풀로 기록한 YouTube 녹화본과 썸네일을 연결했습니다.",
        ...
        s4_note_access: "현재 공식 문서는 모든 ChatGPT 플랜에 Codex가 포함된다고 설명합니다. 처음 보는 사용자라면 `Free $0`, `Go $8`, `Plus $20`, `Pro from $100` 순으로 보면 이해가 쉽고, 팀 사용자는 Business·Enterprise의 Codex-only pay-as-you-go seat를 같이 보면 됩니다. Pricing 페이지는 Plus / Pro 5x / Pro 20x / Business / API Key 표와 모델별 5시간 한도를 보여주며, Plus 기준 로컬 메시지 범위는 `gpt-5.5` 15-80, `gpt-5.4` 20-100, `gpt-5.4-mini` 60-350, `gpt-5.3-codex` 30-150입니다. 다만 최신 Help Center rate card는 대부분의 Plus, Pro, Business, Enterprise/Edu/Gov/Health 고객도 토큰 기반 rate card를 쓰도록 마이그레이션됐다고 설명합니다. 그래서 실제 비용 판단은 메시지/작업 한도, token credit rate card, usage dashboard를 함께 봐야 합니다. Codex 안에서 API 키 로그인은 `gpt-5.5`를 아직 제공하지 않고, OpenAI API 자체에서는 `gpt-5.5`와 `gpt-5.5-pro`가 별도 모델로 제공됩니다. 이미지 생성은 일반 Codex 한도를 평균 3-5배 더 빨리 쓰며 Fast mode는 지원 모델에서 더 높은 비율로 크레딧을 소모합니다.",
        ...
        s13_c1_t: "무엇을 고정할까",
        s13_c1_d: "모델, model_provider, review_model, reasoning effort, sandbox mode, approval policy, web_search, profile, MCP 서버처럼 세션마다 흔들리면 품질 차이가 큰 항목부터 기본값으로 고정하세요. AWS limited preview처럼 Bedrock 경로를 쓰는 팀은 provider 설정도 운영 표준에 포함해야 합니다. 필요하면 Windows 전용 `windows.sandbox`와 `windows.sandbox_private_desktop`도 함께 고정하세요.",
        s13_c2_t: "권한은 좁게 시작",
    ...
    en: {
        ...
        overview_lead: "This section starts with two things: which model/surface choices are current, and where first-time and professional users should begin. Today's edits are available first in the toggle directly below.",
        overview_update_1_title: "Model and surface matrix rechecked",
        overview_update_1_desc: "The run started by re-checking `codex/models` today, confirming that `gpt-5.5` is still the top recommendation, that `gpt-5.4` remains the fallback path, and clarifying how `gpt-5.4-mini` and `gpt-5.3-codex` split fast local/subagent and Cloud/code-review roles. The login-path distinction stays explicit up front: inside Codex, `gpt-5.5` currently appears only with ChatGPT sign-in, not API-key authentication.",
        overview_update_2_title: "Pricing and credits refreshed",
        overview_update_2_desc: "The guide keeps the `GPT-5.5` usage tables, `Free $0`, `Go $8`, `Plus $20`, `Pro from $100`, the Business/Enterprise Codex-only pay-as-you-go path, and the current Plus / Pro 5x / Pro 20x / Business / API Key pricing layout aligned. I also rechecked the Help Center Codex rate card, which says most Plus, Pro, Business, Enterprise/Edu/Gov/Health customers have moved to token-based rate cards after April 23, 2026.",
        ...
        overview_update_4_title: "App feature flow rechecked",
        overview_update_4_desc: "I cross-checked the April 16, 2026 `Codex for (almost) everything` launch post against current `app/features` and `app/automations`, then confirmed background computer use, more plugins, multiple terminal tabs, SSH devboxes, and richer artifact/sidebar flows are still grouped correctly in the guide structure.",
        overview_update_5_title: "Broader launch-post sweep",
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together to compare the April 30 `Advanced Account Security` launch, the April 28 `OpenAI models, Codex, and Managed Agents come to AWS` launch, the April 23 `Introducing GPT-5.5` launch, the April 16 `Codex for (almost) everything` update, the April 2 pay-as-you-go pricing launch, and the latest app/plugins/skills/automations docs. This run updates the top toggle and the model/app/pricing/security explanations directly instead of adding a new chapter.",
        ...
        overview_fact_3_desc: "Quickstart still says every ChatGPT plan includes Codex. The current `codex/pricing` page keeps the Plus / Pro 5x / Pro 20x / Business / API Key tables and the published Plus local-message ranges (`gpt-5.5` 15-80, `gpt-5.4` 20-100, `gpt-5.4-mini` 60-350, `gpt-5.3-codex` 30-150). However, the latest OpenAI Help Center Codex rate card says that after April 23, 2026 most Plus, Pro, Business, Enterprise/Edu/Gov/Health customers should use the token-based rate card. The guide now tells readers to check usage tables, token credit rates, and the usage dashboard together before making cost or limit decisions.",
        overview_fact_4_title: "IDE and Windows paths clarified",
        overview_fact_4_desc: "The IDE docs now cover both VS Code-style editors and JetBrains across macOS, Windows, and Linux. The Windows docs frame native Windows as the default path, recommend the `elevated` sandbox first, and keep `unelevated` as the fallback when admin-approved setup or policy blocks elevated mode. WSL2 is now positioned as the right path when you need a Linux-native toolchain or your workflow already lives inside WSL2.",
        ...
        changelog_item_2: "Updated pricing to the current Plus / Pro 5x / Pro 20x / Business / API Key reading path, and added the Help Center rate-card note that most plans have moved to token-based pricing.",
        ...
        changelog_item_6: "Explained Codex Pet as a skill-installed, repeatable pet-building workflow and linked the full raw YouTube recording with its thumbnail.",
        ...
        s4_note_access: "The official docs still say every ChatGPT plan includes Codex. For first-time users, the easiest reading order is `Free $0` -> `Go $8` -> `Plus $20` -> `Pro from $100`; for teams, add the Business/Enterprise Codex-only pay-as-you-go seat path. The Pricing page breaks usage out by Plus / Pro 5x / Pro 20x / Business / API Key and still shows model-specific five-hour limits. On Plus, the published local-message ranges are `gpt-5.5` 15-80, `gpt-5.4` 20-100, `gpt-5.4-mini` 60-350, and `gpt-5.3-codex` 30-150. However, the latest Help Center rate card says most Plus, Pro, Business, Enterprise/Edu/Gov/Health customers have migrated to token-based rate cards. In practice, check the message/task limits, token credit rate card, and usage dashboard together before planning cost or capacity. Inside Codex, API-key sign-in still does not expose `gpt-5.5`; in the OpenAI API, `gpt-5.5` and `gpt-5.5-pro` are separate models. Built-in image generation uses the same general limits about 3-5x faster on average, and Fast mode consumes credits faster on supported models.",
        ...
        s13_c1_d: "Start by fixing the defaults that most affect consistency: model choice, model_provider, review_model, reasoning effort, sandbox mode, approval policy, web_search, profiles, and MCP setup. Teams using the AWS limited-preview Bedrock path should treat provider configuration as part of the rollout standard. Also set `windows.sandbox` plus `windows.sandbox_private_desktop` if you work natively on Windows.",
