...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, Codex changelog, `developers.openai.com/blog`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 공개 OpenAI news index의 최신 항목은 여전히 2026년 6월 30일 글들이어서 오늘 새 Codex 제품 발표는 추가하지 않았습니다. 다만 2026년 7월 1일 Codex CLI 0.142.5 changelog는 Responses WebSocket request payload가 trace log에 남지 않도록 막은 보안/로그 hygiene bug fix라서 별도 운영 메모로 반영했습니다.",
        ...
        changelog_item_4: "공식 use-case catalog 60개를 다시 감사했고, 6개 Starter prompt drift를 반영한 뒤 local `official.promptEn` mismatch 0을 확인했습니다. 특히 `follow-goals`와 `chatgpt-apps`의 바뀐 공식 prompt 구조를 한국어 1:1 번역까지 동기화했습니다.",
        changelog_item_5: "OpenAI Developers/blog와 openai.com/index를 확인했고, 공개 news index가 2026년 6월 30일 항목까지인 것을 기준으로 새 Codex 제품 발표는 추가하지 않았습니다.",
        changelog_item_6: "OpenAI 담당자 팁 섹션을 사람별 카드로 바꿨습니다. 각 카드는 관련 X 원글, LinkedIn 게시물 흐름, 공식 문서로 바로 연결되고, 공개 가이드는 실전 조언 중심으로 읽히게 했습니다.",
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, the Codex changelog, `developers.openai.com/blog`, `openai.com/index`, and `openai.com/codex` together. The public OpenAI news index still tops out at June 30, 2026 items, so no newer Codex product launch was added today. The July 1, 2026 Codex CLI 0.142.5 changelog is reflected separately as a security/logging hygiene fix that prevents full Responses WebSocket request payloads from being written to trace logs.",
        ...
        changelog_item_4: "Audited all 60 official use cases again. After updating six Starter prompt drifts, including the changed `follow-goals` and `chatgpt-apps` prompts, local prompts have 0 official prompt mismatches and 0 Korean structure regressions.",
        changelog_item_5: "Rechecked OpenAI Developers/blog and openai.com/index; the public news index still tops out at June 30, 2026, so no newer Codex product launch was added.",
        changelog_item_6: "Changed the OpenAI practitioner tips section into person-linked cards. Each card points to the relevant X post, LinkedIn post stream, or official documentation, while the public guide keeps only the practical advice.",
