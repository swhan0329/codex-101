...
const translations = {
    ko: {
        ...
        changelog_item_3: "Quickstart, App/IDE/CLI/Cloud, Remote connections, Windows, Sites, config, MCP/hooks/plugins/skills 문서를 다시 훑었고, config reference의 `features.code_mode`, `features.rollout_budget`, managed `allow_remote_control` 같은 관리 키를 보강했습니다.",
        ...
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했고, X의 reset-bank 커뮤니티 이벤트 글은 공식 문서로 대조되지 않아 local note에만 남겼습니다.",
        ...
        field_tips_intro: "2026-07-02 저장된 social research note를 baseline으로 다시 확인했습니다. Chrome에서 X는 VB/Dominik의 Codex reset-bank 커뮤니티 이벤트 글을 읽을 수 있었지만 공식 문서로 대조 가능한 새 product guidance는 아니었습니다. Threads와 LinkedIn은 커뮤니티·분석성 글이 대부분이라 검증되지 않은 소셜 claim은 추가하지 않았습니다. 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        changelog_item_3: "Rechecked Quickstart, App/IDE/CLI/Cloud, Remote connections, Windows, Sites, config, MCP, hooks, plugins, and skills; added config-reference admin keys such as `features.code_mode`, `features.rollout_budget`, and managed `allow_remote_control`.",
        ...
        changelog_item_6: "Reused the saved social research note as the baseline; the X reset-bank community event post was not promoted because it is not corroborated by official docs.",
        ...
        field_tips_intro: "On July 2, 2026, I reused the saved people/social research note as the baseline. X exposed a VB/Dominik Codex reset-bank community event post, but it was not new product guidance corroborated by official docs. Threads and LinkedIn were mostly community or analysis posts. Product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
