...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 25일 `How agents are transforming work`는 Codex가 장기·병렬·비개발자 업무로 확장되는 연구 맥락으로, 2026년 6월 9일 Nextdoor customer story는 GPT-5.5와 Fast mode를 쓰는 enterprise 운영 사례로 분리했습니다. 2026년 6월 24일 AWS 발표는 enterprise/provider 배포 맥락으로, Workspace Agents는 ChatGPT 팀 계정용 shared cloud agent research preview로 분리했습니다. 2026년 6월 26일 GPT-5.6 Sol preview는 일부 신뢰 파트너/조직 preview와 broader availability coming soon으로 분리했고, HP partnership는 enterprise adoption 사례로만 남겼습니다. Daybreak/Patch the Planet/Codex-maxxing은 계속 보안/장기작업 운영 맥락이며, 새 일반 Codex 모델 순서, 일반 사용자 플랜, local app 설정 키, credential/permission 변화로 단정하지 않았습니다.",
        ...
        changelog_item_3: "Quickstart, App/IDE/CLI/Cloud, Remote connections, Windows, Sites, config, MCP/hooks/plugins/skills 문서를 다시 훑었고, config/remote-control/Sites/Windows 활성화 절차와 충돌하는 새 공식 변경은 없었습니다.",
        changelog_item_4: "공식 use-case catalog 60개를 다시 감사했고, Starter prompt 원문 60개와 local `official.promptEn` mismatch 0을 확인했습니다. promptEn/promptKo 누락 0, multiline 한국어 요약 회귀 0입니다.",
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, agentic work 연구와 Nextdoor customer story는 제품 기능 변화가 아니라 장기/병렬/비개발자/Fast mode 운영 맥락으로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했습니다. Chrome 전용 제어는 노출되지 않았고 X/LinkedIn은 로그인 redirect, Threads는 noisy public post만 보여 검증되지 않은 소셜 claim은 추가하지 않았습니다.",
        ...
        s18_field_credit: "이번 실행의 Chrome 소셜 확인에서는 X에서 Codex reset-bank 커뮤니티 이벤트 글을 읽을 수 있었고, Threads/LinkedIn은 커뮤니티·분석성 글이 대부분이었습니다. 소셜 글은 현장 신호로만 다루고, AGENTS/config 기반 재현성, permissions 확인, OpenAI Developers plugin 활용처럼 공식 문서와 맞는 팁만 유지합니다.",
        ...
        field_tips_intro: "2026-07-04 저장된 social research note를 baseline으로 다시 확인했습니다. 이번 세션에는 Chrome 전용 제어 도구가 노출되지 않았고, Playwright fallback의 번들 Chromium도 설치되어 있지 않았습니다. system Chrome fallback에서는 X와 LinkedIn이 로그인으로 redirect되고 Threads는 noisy public post만 보여서, 검증되지 않은 소셜 claim은 추가하지 않았습니다. 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로만 대조했습니다.",
        field_tip_1_t: "Reset bank는 아껴 쓰는 예비 체력",
        field_tip_1_d: "초대나 프로모션으로 생기는 rate-limit reset은 긴 작업을 무작정 키우는 면허가 아닙니다. 큰 refactor, eval 반복, 배포 재시도처럼 검증 루프가 있는 일에 쓰고, 세션 안에서는 여전히 작은 checkpoint로 나누세요.",
        ...
        field_tip_6_t: "OpenAI 답변은 docs agent부터",
        field_tip_6_d: "Codex, API, Agents SDK, ChatGPT Apps처럼 바뀌는 주제는 소셜 글이나 기억만으로 단정하지 말고 OpenAI developer docs agent나 Docs MCP로 공식 문서를 먼저 찾으세요. Codex 제품 기능과 API 플랫폼 기능도 섞지 마세요.",
        field_tip_7_t: "Sites는 preview 배포 surface",
        field_tip_7_d: "@Sites는 Codex가 웹사이트, 내부 앱, 게임을 만들고 OpenAI-hosted URL로 저장/배포하게 하는 preview 기능입니다. 현재 공식 문서 기준으로 Business와 Enterprise workspace 대상이며, Enterprise는 RBAC 활성화가 필요합니다.",
        field_tip_8_t: "Persistent execution은 발표와 운영을 분리",
        field_tip_8_d: "Ona 인수 발표는 Codex가 장시간 enterprise 작업을 고객 통제 cloud 환경에서 이어가는 방향을 보여줍니다. 다만 인수는 closing 조건이 남아 있으므로, 지금 켜는 설정처럼 쓰지 말고 공식 발표와 현재 사용 가능한 기능을 분리해서 설명하세요.",
        field_tip_9_t: "데이터 일은 먼저 metric contract",
        field_tip_9_d: "Data Analytics plugin을 쓸 때는 “분석해줘”보다 north star, success metrics, guardrails, data gaps를 먼저 정의하게 하세요. 그 다음 query/report와 반복 KPI 점검으로 넘어가야 결과가 검토 가능한 artifact가 됩니다.",
        field_tip_10_t: "모바일은 host 제어판처럼 쓰기",
        field_tip_10_d: "휴대폰에서 모든 파일이 옮겨가는 것이 아닙니다. 공식 Remote connections 문서 기준으로 ChatGPT 모바일 앱은 켜져 있는 Mac/Windows host의 프로젝트, thread, 승인, diff, test, terminal output을 이어서 조종하고, 파일·credential·plugin·Computer Use 권한은 host에 남습니다.",
        ...
        field_tips_refs: '원글 및 근거: <a href="https://x.com/dkundel/status/2062650378089594955" target="_blank">Dominik /goal</a> · <a href="https://x.com/heccbrent/status/2062651567413637441" target="_blank">Brent /goal</a> · <a href="https://x.com/reach_vb/status/2065520558620500082" target="_blank">VB Build macOS Apps</a> · <a href="https://x.com/reach_vb" target="_blank">VB Codex Mobile note</a> · <a href="https://developers.openai.com/codex/remote-connections" target="_blank">Official Remote connections</a> · <a href="https://x.com/_lopopolo/status/2064742429438198056" target="_blank">Ryan AGENTS.md</a> · <a href="https://x.com/nicolekcha/status/2063362606543622322" target="_blank">Nicole skills framing</a> · <a href="https://developers.openai.com/codex/use-cases/follow-goals" target="_blank">Official /goal</a> · <a href="https://developers.openai.com/codex/sites" target="_blank">Official Sites</a> · <a href="https://openai.com/index/openai-to-acquire-ona/" target="_blank">Official Ona announcement</a> · <a href="https://developers.openai.com/codex/skills" target="_blank">Official Skills</a> · <a href="https://developers.openai.com/codex/plugins" target="_blank">Official Plugins</a>',
        // Footer
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 25 `How agents are transforming work` paper is now recorded as research context for longer-horizon, parallel, and non-developer Codex work. The June 9 Nextdoor customer story is recorded as enterprise operating context for GPT-5.5 and Fast mode. The June 24 AWS announcement remains enterprise/provider deployment context, and Workspace Agents remains a ChatGPT team-workspace shared cloud-agent research preview. The June 26 GPT-5.6 Sol preview is separated as limited partner/organization preview plus broader availability coming soon, while the HP partnership remains enterprise adoption context. None of these are general Codex model-order, consumer-plan, local app config, credential, or permission changes.",
        ...
        changelog_item_3: "Rechecked Quickstart, App/IDE/CLI/Cloud, Remote connections, Windows, Sites, config, MCP, hooks, plugins, and skills; no new official change conflicted with config, remote-control, Sites, or Windows setup wording.",
        changelog_item_4: "Audited all 60 official use cases again. Local Starter prompts have 0 official prompt mismatches, 0 missing promptEn, 0 missing promptKo, and 0 multiline Korean summary regressions.",
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; agentic work research and the Nextdoor customer story were added only as long-horizon, parallel, non-developer, and Fast mode operating context.",
        changelog_item_6: "Reused the saved social research note as the baseline. Chrome-specific control was not exposed, X/LinkedIn redirected to login, and Threads showed noisy public posts, so no unverified social claim was promoted.",
        ...
        s18_field_credit: "This run used Chrome to recheck the targeted X, Threads, and LinkedIn surfaces. X exposed a Codex reset-bank community event post, while Threads and LinkedIn were mostly community or analysis posts. Social posts stay as field signals, and the guide keeps only tips that fit official docs, such as AGENTS/config reproducibility, permission checks, and OpenAI Developers documentation workflows.",
        ...
        field_tips_intro: "On July 4, 2026, I reused the saved people/social research note as the baseline. Chrome-specific control was not exposed in this session, the Playwright bundled Chromium was not installed, and the system Chrome fallback redirected X/LinkedIn to login while Threads showed noisy public posts. No unverified social claim was added; product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
        field_tip_1_t: "Treat reset banks as reserve capacity",
        field_tip_1_d: "A rate-limit reset from an invite or promotion is not a license to make every task bigger. Spend it on work with a validation loop, such as a large refactor, eval run, or deployment retry, and still break the session into small checkpoints.",
        ...
        field_tip_6_t: "Use the docs agent for OpenAI answers",
        field_tip_6_d: "For changing topics such as Codex, the API, Agents SDK, and ChatGPT Apps, do not rely only on social posts or memory. Start with the OpenAI developer docs agent or Docs MCP, and keep Codex product behavior separate from API platform behavior.",
        field_tip_7_t: "Sites is a preview deployment surface",
        field_tip_7_d: "@Sites lets Codex create, save, deploy, and inspect websites, internal apps, and games hosted by OpenAI. Official docs currently describe it as a Business and Enterprise workspace preview, with Enterprise RBAC required before members can use it.",
        field_tip_8_t: "Separate persistent-execution news from operation",
        field_tip_8_d: "The Ona acquisition announcement shows a direction for Codex to keep long-running enterprise work inside customer-controlled cloud environments. Because closing conditions remain, describe it as an official announcement, not as a setting users can enable today.",
        field_tip_9_t: "Start data work with a metric contract",
        field_tip_9_d: "When using the Data Analytics plugin, avoid a vague “analyze this.” Ask Codex to define the north star, success metrics, guardrails, and data gaps first. Then move to queries, reports, and recurring KPI checks so the output remains reviewable.",
        field_tip_10_t: "Use mobile as a host control plane",
        field_tip_10_d: "Your phone does not move the whole working environment onto itself. The official Remote connections docs describe ChatGPT mobile as controlling an awake Mac or Windows host: projects, threads, approvals, diffs, tests, and terminal output stay connected, while files, credentials, plugins, Computer Use, and local permissions remain on the host.",
