...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `developers.openai.com/blog`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 공개 OpenAI news index의 최신 항목은 여전히 2026년 6월 30일 글들이어서 오늘 새 Codex 제품 발표는 추가하지 않았습니다. 기존 Codex Remote, private MCP server/Secure MCP Tunnel, Simplex customer story, `Dreaming` 메모는 각각 운영, Platform/API, enterprise adoption, ChatGPT memory 맥락으로 분리했습니다.",
