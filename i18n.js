...
const translations = {
    ko: {
        ...
        changelog_item_4: "공식 use-case catalog 60개를 다시 감사했고, 6개 Starter prompt drift를 반영한 뒤 local `official.promptEn` mismatch 0을 확인했습니다. promptEn/promptKo 누락 0, multiline 한국어 요약 회귀 0입니다.",
        ...
        changelog_item_6: "저장된 social research note를 baseline으로 재확인했습니다. Chrome plugin 연결은 `Browser is not available: extension`으로 실패했고 Codex in-app browser만 노출되어 검증되지 않은 소셜 claim은 추가하지 않았습니다.",
    ...
    en: {
        ...
        changelog_item_4: "Audited all 60 official use cases again. After updating six Starter prompt drifts, local prompts have 0 official prompt mismatches, 0 missing promptEn, 0 missing promptKo, and 0 multiline Korean summary regressions.",
        ...
        changelog_item_6: "Reused the saved social research note as the baseline. Chrome plugin connection failed with `Browser is not available: extension`, and only the Codex in-app browser was exposed, so no unverified social claim was promoted.",
