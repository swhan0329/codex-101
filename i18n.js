...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 14일 `Introducing the OpenAI Partner Network`는 enterprise adoption과 partner delivery 생태계 맥락으로만 분리했습니다. 6월 16일 Deployment Simulation은 모델 출시 전 안전/행동 평가 방식, 6월 17일 LifeSciBench는 생명과학 연구 benchmark와 GPT-Rosalind 접근 요청 맥락으로만 기록했습니다. 이 발표들은 Codex의 새 모델 순서, 일반 사용자 플랜, preview/GA, feature flag, activation 절차, credential/permission 변화가 아닙니다. 6월 11일 Ona와 6월 10일 Oracle cloud commitment도 각각 enterprise execution/procurement 맥락으로만 유지했습니다.",
        ...
        changelog_item_4: "공식 use-case catalog 60개를 다시 감사했고, promptEn/promptKo 누락 0, official prompt mismatch 0, multiline 한국어 요약 회귀 0, 공식 한국어 prompt token 보존 실패 0을 확인했습니다.",
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, Partner Network, Deployment Simulation, LifeSciBench를 Codex 기능 변경이 아닌 enterprise/research/eval 맥락으로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 X, Threads, LinkedIn을 다시 확인했지만 shell/blank 결과만 보여 공식 문서로 대조 가능한 새 social tip은 추가하지 않았습니다.",
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 14 `Introducing the OpenAI Partner Network` announcement remains enterprise adoption context. The June 16 Deployment Simulation post is model safety and behavior-evaluation context, and the June 17 LifeSciBench post is life-science benchmarking and GPT-Rosalind access-request context. I did not describe any of these as a Codex model-order, consumer-plan, preview/GA, feature-flag, activation, credential, or permission change. The June 11 Ona post and June 10 Oracle cloud commitment stay separated as enterprise execution and procurement context.",
        ...
        changelog_item_4: "Audited all 60 official use cases again and confirmed 0 missing promptEn, 0 missing promptKo, 0 official prompt mismatches, 0 multiline Korean summary regressions, and 0 official Korean prompt token-preservation failures.",
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; Partner Network, Deployment Simulation, and LifeSciBench are enterprise/research/eval context, not Codex feature changes.",
        changelog_item_6: "Used the saved social research note as the baseline and rechecked X, Threads, and LinkedIn; shell/blank results produced no new officially corroborated social tip.",
        ...
        field_tips_intro: "On June 18, 2026, I reused the saved people/social research note as the baseline and rechecked X, Threads, and LinkedIn through the logged-in Chrome session. Social posts are treated as field signals, while product status and enablement steps are checked against official Codex docs and OpenAI announcements. This pass did not add a new social-only claim because no new officially corroborated Codex tip surfaced.",
