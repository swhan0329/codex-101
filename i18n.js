...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 5월 27일 Tax AI/Codex engineering 글은 실무자 correction, production trace, eval target, bounded task environment, human review를 묶는 self-improving agent 운영 패턴으로 반영했습니다. 같은 날 election safeguards 글은 Codex Security와 OpenAI 생성 이미지 provenance의 보안/투명성 맥락으로만 기록했고, 일반 사용자가 켜야 하는 기능처럼 쓰지는 않았습니다. 2026년 5월 22일 Gartner enterprise coding agents 발표와 2026년 5월 18일 Dell Technologies 파트너십 발표는 계속 enterprise governance와 hybrid/on-prem deployment 맥락으로만 유지했습니다.",
        ...
        changelog_item_4: "2026년 5월 27일 Tax AI/Codex 글을 새 토글이 아니라 practitioner feedback, production traces, eval targets, bounded tasks, human review를 묶는 고급 운영 패턴으로 추가했습니다.",
        changelog_item_5: "Docs MCP, best practices, config, OpenAI API changelog/deprecations, API 모델 문서, Windows sandbox 발표, Dell/Gartner enterprise 발표, election safeguards의 Codex Security/provenance 맥락을 다시 확인했습니다. Secure MCP Tunnel은 Platform/API enterprise 항목으로만 분리했습니다.",
        changelog_item_6: "Chrome 플러그인으로 X, Threads, LinkedIn을 확인했지만 세 페이지 모두 읽을 수 있는 본문이 비어 있었습니다. 검증되지 않은 소셜 claim은 추가하지 않았습니다.",
        ...
        s18_field_credit: "이번 실행에서는 Chrome 연결이 성공했지만 X, Threads, LinkedIn 모두 읽을 수 있는 페이지 본문이 비어 있었습니다. 검증되지 않은 주장은 추가하지 않았고, 공식 문서와 맞는 권한 확인, 출력 계약, 도구 사용 규칙, 완료 기준, OpenAI Developers plugin 활용 메모만 기존 prompting guidance와 연결했습니다.",
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The May 27 Tax AI/Codex engineering post is reflected as a self-improving agent operating pattern built from practitioner corrections, production traces, eval targets, bounded task environments, and human review. The May 27 election safeguards post is noted only as security/provenance context for Codex Security and OpenAI-generated images, not as a general feature to enable. The May 22 Gartner and May 18 Dell posts remain enterprise governance and hybrid/on-prem deployment context.",
        ...
        changelog_item_4: "Added the May 27 Tax AI/Codex post as an advanced operating pattern for practitioner feedback, production traces, eval targets, bounded tasks, and human review, not as a new toggle.",
        changelog_item_5: "Rechecked Docs MCP, best practices, config, the OpenAI API changelog/deprecations, API model docs, the Windows sandbox post, Dell/Gartner enterprise announcements, and election-safeguards Codex Security/provenance context; Secure MCP Tunnel stays in the Platform/API enterprise lane.",
        changelog_item_6: "The Chrome plugin checked X, Threads, and LinkedIn, but all three returned blank readable page bodies. No unverified social claim was added.",
        ...
        s18_field_credit: "Chrome connected successfully in this run, but X, Threads, and LinkedIn returned blank readable page bodies. I did not add unverified claims; I only tied official-doc-aligned notes on permissions, output contracts, tool-use rules, done criteria, and the OpenAI Developers plugin back to existing guidance.",
