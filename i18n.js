...
const translations = {
    ko: {
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, GPT-5.6 Sol preview는 제한 preview/Platform API 맥락으로 분리했습니다.",
        ...
        field_tips_intro: "2026-06-28 저장된 social research note를 baseline으로 다시 확인했습니다. 이번 실행에서는 X, Threads, LinkedIn을 신뢰할 만큼 읽을 수 있는 Chrome 제어 경로가 충분하지 않아 검증되지 않은 소셜 claim은 추가하지 않았습니다. 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
    ...
    en: {
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; GPT-5.6 Sol preview is separated as limited preview / Platform API context.",
