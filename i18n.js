...
const translations = {
    ko: {
        ...
        overview_update_1_desc: "`codex/models`를 2026년 6월 13일 기준으로 가장 먼저 다시 확인했고, `gpt-5.5` 최우선 추천, `gpt-5.4` 대체 선택지, `gpt-5.4-mini`의 빠른 로컬/subagent 역할, `gpt-5.3-codex-spark`의 Pro research preview 역할이 유지되는지 대조했습니다. 현재 models 문서는 계속 `gpt-5.2`와 `gpt-5.3-codex`를 ChatGPT 로그인 기준 Codex에서는 deprecated라고 명시합니다. API-key authentication을 쓰는 workflow는 API models page에서 별도로 확인해야 하며, 임의 provider에서 Chat Completions API를 쓰는 Codex 경로는 future release에서 제거될 예정인 deprecated 지원입니다.",
        ...
        changelog_item_6: "로그인된 Chrome으로 X와 LinkedIn의 사람별 최신 글을 다시 확인하고, 공식 문서로 대조 가능한 Codex 팁만 섹션 20과 별도 리서치 노트에 반영했습니다.",
        ...
        field_tips_intro: "2026-06-13 로그인된 Chrome 세션으로 X, Threads, LinkedIn의 최신 글을 다시 확인했습니다. 소셜 글은 “현장 신호”로만 쓰고, 제품 상태와 활성화 방법은 공식 Codex 문서와 OpenAI 발표로 대조했습니다.",
        ...
        field_tips_refs: '원글 및 근거: <a href="codex-team-social-research-2026-06-13.md" target="_blank">2026-06-13 사람별 소셜 리서치 노트</a> · <a href="https://x.com/dkundel/status/2062650378089594955" target="_blank">Dominik /goal</a> · <a href="https://x.com/heccbrent/status/2062651567413637441" target="_blank">Brent /goal</a> · <a href="https://x.com/reach_vb/status/2065520558620500082" target="_blank">VB Build macOS Apps</a> · <a href="https://x.com/_lopopolo/status/2064742429438198056" target="_blank">Ryan AGENTS.md</a> · <a href="https://x.com/nicolekcha/status/2063362606543622322" target="_blank">Nicole skills framing</a> · <a href="https://developers.openai.com/codex/use-cases/follow-goals" target="_blank">Official /goal</a> · <a href="https://developers.openai.com/codex/sites" target="_blank">Official Sites</a> · <a href="https://openai.com/index/openai-to-acquire-ona/" target="_blank">Official Ona announcement</a> · <a href="https://developers.openai.com/codex/skills" target="_blank">Official Skills</a> · <a href="https://developers.openai.com/codex/plugins" target="_blank">Official Plugins</a>',
        // Footer
    ...
    en: {
        ...
        changelog_item_6: "Rechecked recent posts from individual people on X and LinkedIn through logged-in Chrome, then added only Codex tips that could be separated from or corroborated by official docs.",
        ...
        field_tips_intro: "On June 13, 2026, I rechecked recent posts on X, Threads, and LinkedIn through the logged-in Chrome session. Social posts are treated as field signals, while product status and enablement steps are checked against official Codex docs and OpenAI announcements.",
