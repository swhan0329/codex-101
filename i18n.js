...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 14일 `Introducing the OpenAI Partner Network`는 enterprise adoption과 partner delivery 생태계 맥락으로만 분리했습니다. 고객이 use case를 찾고, workflow를 재설계하고, 기존 시스템과 통합하고, adoption/change management를 진행하도록 돕는 발표이지, Codex의 새 모델 순서, 일반 사용자 플랜, preview/GA, feature flag, activation 절차, credential/permission 변화는 아닙니다. 6월 11일 Ona, 6월 10일 Oracle cloud commitment, 6월 11일 black-hole simulation 글도 각각 enterprise execution/procurement/research workflow 맥락으로만 유지했습니다.",
        ...
        changelog_item_5: "OpenAI Developers MCP와 openai.com/index를 확인했고, 6월 14일 Partner Network 발표는 Codex 기능 변경이 아니라 enterprise adoption 맥락으로 분리했습니다.",
        changelog_item_6: "저장된 social research note를 baseline으로 X, Threads, LinkedIn을 다시 확인했지만 공식 문서로 대조 가능한 새 social tip은 없어 추가하지 않았습니다.",
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 14 `Introducing the OpenAI Partner Network` announcement is enterprise adoption and partner-delivery context: it helps customers identify use cases, redesign workflows, integrate with existing systems, and manage adoption. I did not describe it as a Codex model-order, consumer-plan, preview/GA, feature-flag, activation, credential, or permission change. The June 11 Ona post, June 10 Oracle cloud commitment, and June 11 black-hole simulation article stay separated as enterprise execution, procurement, and research workflow context.",
        ...
        changelog_item_5: "Rechecked OpenAI Developers MCP and openai.com/index; the June 14 Partner Network announcement is enterprise adoption context, not a Codex feature change.",
        changelog_item_6: "Used the saved social research note as the baseline and rechecked X, Threads, and LinkedIn; no new officially corroborated social tip was added.",
