...
const translations = {
    ko: {
        ...
        overview_update_5_desc: "`developers.openai.com/codex`, `openai.com/index`, `openai.com/codex` 아래 관련 페이지를 다시 훑어봤습니다. 2026년 6월 2일 `Codex for every role, tool, and workflow` 발표는 role-specific plugins, Sites preview, 더 넓어진 annotations를 공식 발표 문구로 추가하고, 같은 날 `Codex is becoming a productivity tool for everyone` 글은 지식근로자가 data analysis, research, knowledge artifact, lightweight tool 생성에 Codex를 쓰는 배경 보고서로 분리했습니다. 2026년 5월 13일 TanStack/Mini Shai-Hulud 대응 공지는 macOS 사용자가 2026년 6월 12일까지 Codex App/CLI 등 OpenAI macOS 앱을 공식 경로로 업데이트해야 하는 보안 운영 메모로 추가했습니다.",
        ...
        changelog_item_6: "Chrome으로 X, Threads, LinkedIn을 다시 확인했고, 새 social-only claim은 추가하지 않은 채 공식 문서로 확인되는 실무 습관만 유지했습니다.",
        ...
        field_tips_intro: "2026-06-09 Chrome 로그인 세션으로 X, Threads, LinkedIn을 확인했지만 새로 넣을 만한 공식 근거의 social-only claim은 없었습니다. 아래에는 이미 공식 문서와 대조해 둔 사용 습관만 남겼습니다.",
    ...
    en: {
        ...
        overview_update_5_desc: "I re-read `developers.openai.com/codex`, `openai.com/index`, and `openai.com/codex` together. The June 2 `Codex for every role, tool, and workflow` launch remains official announcement language for role-specific plugins, Sites preview, and broader annotations. The same-day `Codex is becoming a productivity tool for everyone` post is now treated as report context for knowledge-worker use across data analysis, research, knowledge artifacts, workflow automation, and lightweight tools. The May 13 TanStack / Mini Shai-Hulud response is added as a security operations note: macOS users should update OpenAI macOS apps, including Codex App and Codex CLI, from official paths by June 12, 2026.",
        ...
        changelog_item_6: "Rechecked X, Threads, and LinkedIn in Chrome, added no new social-only claims, and kept only official-doc-corroborated practice patterns.",
        ...
        field_tips_intro: "On June 9, 2026, I checked recent X posts from OpenAI Codex practitioners through the logged-in Chrome session, then cross-checked the patterns against official docs before keeping them here.",
