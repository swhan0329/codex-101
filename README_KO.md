...
<p align="center">
  <strong>최종 업데이트: 2026년 7월 4일</strong><br/>
...
- `openai.com/index`에서는 2026년 6월 25일 [How agents are transforming work](https://openai.com/index/how-agents-are-transforming-work/)와 2026년 6월 9일 [Nextdoor customer story](https://openai.com/index/nextdoor/)를 추가 확인했습니다. 전자는 장기/병렬/비개발자 Codex 업무 확장 연구이고, 후자는 GPT-5.5/Fast mode를 쓰는 enterprise 사례입니다. 둘 다 Codex 모델, 플랜, preview/GA, feature flag, activation, credential, permission 변화로 승격하지 않았습니다.
...
- 2026년 7월 4일에는 공식 use-case catalog도 데이터셋 단위로 다시 감사했습니다. collection page를 제외한 공식 카드는 60개로 유지됐고, local/official ID 차이 0, `promptEn` 누락 0, `promptKo` 누락 0, official prompt mismatch 0, multiline 공식 prompt인데 한국어가 1줄 요약인 항목 0입니다.
