...
<p align="center">
  <strong>최종 업데이트: 2026년 8월 17일</strong><br/>
...
- 공식 use-case catalog는 collection page를 제외한 local 카드 101개 기준으로 다시 감사했습니다. 공식 개별 페이지 101개, local 카드 101개, `promptEn` 누락 0, `promptKo` 누락 0, 공식 Starter prompt mismatch 0, fetch error 0, line/token 구조 회귀 0입니다. `use-cases-data.js` scrape date는 2026-08-17로 맞췄습니다.
