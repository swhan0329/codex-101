...
<p align="center">
  ...
  CLI (macOS/Linux/Windows) · Desktop App (macOS/Windows) · IDE Extension · Web/Mobile
</p>

<p align="center">
  <strong>최종 업데이트: 2026년 8월 12일</strong><br/>
...
- openai.com/index와 OpenAI Developers/API 문서도 다시 대조했습니다. 오늘은 Codex 제품 추천 모델을 바꿀 항목은 없었습니다. 2026년 8월 11일 Daybreak on AWS 발표는 승인된 Daybreak Access 고객이 Amazon Bedrock 또는 Responses API `bedrock-mantle` endpoint로 Daybreak Blue/Red를 쓰는 보안 배포 맥락입니다. 2026년 8월 10일 Daybreak 발표들은 승인된 defender 전용 보안 맥락으로 분리했습니다. Blue는 GPT-5.6 Sol 기반 defensive workflow, Red는 목적 훈련된 cyber model 기반 authorized vulnerability research/red-team work이며, Daybreak 사용자는 Codex full-access mode 대신 auto-review, scoped permission profile, monitoring을 쓰도록 권고되고 개인 Daybreak 계정은 2026년 9월 1일부터 hardware security key가 요구됩니다. 이를 일반 Codex 설정 flag, 플랜 변경, 모델 추천 변경으로 섞지 않았습니다. Linux도 더 명확히 분리했습니다. ChatGPT 데스크톱 앱은 macOS/Windows 경로이고, Linux 사용자는 Codex CLI standalone installer 또는 npm 설치 경로를 쓰며 Linux sandbox, WSL2, Dev Container 경계를 함께 확인해야 합니다. 2026년 8월 10일 Business Premium 발표는 ChatGPT Business의 사용량·청구 capacity 맥락으로만 기록했습니다. 2026년 8월 6일 GPT-5.6 Sol ChatGPT 발표는 ChatGPT 일반 채팅 모델 접근성/품질 업데이트로만 반영하고, Codex 제품 모델 변경과 섞지 않았습니다. 2026년 8월 4일 교육 발표는 ChatGPT Edu 및 ChatGPT for Teachers district deployment용 교육 plugins/workflow 패키징 맥락으로만 반영했습니다.
- Chrome으로 X, LinkedIn, Threads의 사람별 공개 practitioner signal을 다시 확인했습니다. 오늘 새로 승격할 OpenAI/Codex person-level workflow post는 없었고, Section 20의 기존 practitioner card는 원글 또는 공식 corroborating docs 링크를 유지한 채 변경하지 않았습니다.
