...
<p align="center">
  <strong>최종 업데이트: 2026년 7월 2일</strong><br/>
...
- `openai.com/index` 최신 목록은 오늘도 2026년 6월 30일 게시된 [How people are using ChatGPT](https://openai.com/index/global-ai-and-chatgpt-adoption/), [GeneBench-Pro](https://openai.com/index/genebench-pro/), [Core dump debugging and epidemiology](https://openai.com/index/core-dump-debugging-epidemiology/)가 맨 위입니다. 각각 global adoption research, 생명과학 benchmark, data infrastructure debugging 사례로만 분리했고, Codex 모델, 플랜, preview/GA, feature flag, activation, credential, permission 변화로 승격하지 않았습니다.
...
- 저장된 social research note를 baseline으로 다시 확인했습니다. Chrome에서 X는 VB/Dominik의 Codex reset-bank 커뮤니티 이벤트 글을 읽을 수 있었고, Threads/LinkedIn은 커뮤니티·분석성 글이 대부분이었습니다. 공식 문서로 대조 가능한 새 product guidance는 아니므로 공개 가이드에는 올리지 않고 local research note에 관찰로만 남겼습니다.
...
- 2026년 7월 2일에는 공식 use-case catalog도 데이터셋 단위로 다시 감사했습니다. collection page를 제외한 공식 카드는 60개로 유지됐고, local/official ID 차이 0, `promptEn` 누락 0, `promptKo` 누락 0, official prompt mismatch 0, multiline 공식 prompt인데 한국어가 1줄 요약인 항목 0입니다.
