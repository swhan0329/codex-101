...
<p align="center">
  <strong>최종 업데이트: 2026년 4월 2일</strong><br/>
...
- 가격/접근 범위는 계속 Quickstart와 Pricing을 함께 봐야 정확합니다. 현재 문서는 한시적 Free/Go 체험, 유료 ChatGPT 플랜의 2x Codex rate limit 프로모션, 모델별 5시간 로컬/클라우드/코드 리뷰 범위, 평균 크레딧 비용까지 보여줍니다. 실무적으로는 `gpt-5.4`와 `gpt-5.4-mini`가 로컬 중심이고, 클라우드 작업과 GitHub 리뷰는 여전히 `gpt-5.3-codex` 축입니다.
