...
<p align="center">
  <strong>최종 업데이트: 2026년 7월 9일</strong><br/>
...
- `developers.openai.com/blog`와 `openai.com/index`를 다시 확인했습니다. 2026년 7월 8일 GPT-Live 발표는 현재 ChatGPT Voice 중심 출시이고 API/Codex 지원은 작업 중으로 설명되므로, Codex 설정이나 모델 선택기 변화로 승격하지 않았습니다. 2026년 7월 8일 coding evaluation 글은 Codex 기반 investigator agent를 쓴 평가 방법론으로, 2026년 7월 7일 Australian Payments Plus 글은 ChatGPT Enterprise와 Codex 고객 사례로만 분리했습니다.
...
- 2026년 7월 9일에는 공식 use-case catalog도 데이터셋 단위로 다시 감사했습니다. collection page를 제외한 공식 카드는 60개로 유지됐고, local/official ID 차이 0, `promptEn` 누락 0, `promptKo` 누락 0, official prompt mismatch 0, multiline 공식 prompt인데 한국어가 1줄 요약인 항목 0입니다.
