...
<p align="center">
  <strong>최종 업데이트: 2026년 8월 11일</strong><br/>
...
- openai.com/index와 OpenAI Developers/API 문서도 다시 대조했습니다. 오늘은 Codex 제품 추천 모델을 바꿀 항목은 없었습니다. 2026년 8월 10일 Business Premium 발표는 ChatGPT Business의 사용량·청구 capacity 맥락으로만 기록하고 Codex 설정 flag나 모델 선택 변경으로 섞지 않았습니다. 2026년 8월 7일 cybersecurity capabilities 발표는 고성능 agentic system의 security/preparedness 맥락으로만 기록하고, Codex 설정 flag나 모델 선택 변경으로 섞지 않았습니다. 2026년 8월 6일 GPT-5.6 Sol ChatGPT 발표는 ChatGPT 일반 채팅 모델 접근성/품질 업데이트로만 반영하고, Codex 제품 모델 변경과 섞지 않았습니다. 2026년 8월 4일 교육 발표는 ChatGPT Edu 및 ChatGPT for Teachers district deployment용 교육 plugins/workflow 패키징 맥락으로만 반영하고, 일반 Codex 모델·가격·설정 키 변경으로 쓰지 않았습니다.
