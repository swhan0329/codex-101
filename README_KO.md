...
- 섹션 20을 generic field tips block에서 사람별 practitioner card로 다시 정리했습니다. 각 카드는 관련 X 원글, LinkedIn 게시물 흐름, 공식 corroborating page로 바로 연결되고, 공개 가이드에는 “누가 어떤 방식으로 Codex를 쓰라고 말했는지”를 남깁니다.
