    ...
    const homeNavGroups = [
        ...
        },
        {
            ...
            items: [
                ...
                { href: '#s7-computer-use', label: '07.2', titleKey: 's7_pb_computer_t', subitem: true },
                { href: '#s7-image-generation', label: '07.3', titleKey: 's7_pb_image_t', subitem: true },
                { href: '#s7-memories', label: '07.4', titleKey: 's7_pb_memory_t', subitem: true },
                { href: '#s7-thread-automations', label: '07.5', titleKey: 's7_pb_thread_t', subitem: true },
                { href: '#s7-plugins', label: '07.6', titleKey: 's7_pb_plugin_t', subitem: true },
