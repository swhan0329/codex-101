    ...
    function setupUseCasesPage() {
        ...
        const getSkillWhy = (skill) => {
            ...
            const fallback = {
                ...
                'Teams': 'Teams 메시지, 프로젝트 결정, 열려 있는 후속 요청을 확인합니다.',
                'Outlook Email': '프로젝트 관련 Outlook 메일, 보류된 답장, 약속된 요청을 확인합니다.',
                'Finances': '연결된 지출, 예정 결제, 반복 청구서, 구독을 읽기 전용으로 검토합니다.',
                'Google Sheets': '팀이 정렬, 검토, 코멘트할 수 있는 시트 형태의 결과물을 만듭니다.',
                'Documents': '편집 가능한 문서와 보고서를 만들고, 구조·내용·출처 표시를 검토합니다.',
                'Slides': '편집 가능한 발표 자료를 만들고, 렌더링 결과에서 잘림·넘침·레이아웃 문제를 확인합니다.',
                'Spreadsheets': '워크북의 표·수식·지표·차트를 분석하고, 검토 가능한 스프레드시트 산출물을 만듭니다.',
